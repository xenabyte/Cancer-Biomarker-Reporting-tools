  ...
  <div class="main-content">
    ...
    <section>
      <div id="exportContent" class="container">
        ...
        <div class="col-md-12">
            @if($procedure_excision != '' || $procedure_ton != '' || $procedure_laryn != ''  || $procedure_neck_desection != '' || $procedure_other != '' || $procedure_not_specified != '' )
                <p><strong>Procedure:</strong>
                @if($procedure_excision != '') {{ $procedure_excision }}, @endif
                @if($procedure_ton != '') {{ $procedure_ton }}, @endif
                @if($procedure_laryn != '') {{ $procedure_laryn }}, @endif
                @if($procedure_neck_desection != '') {{ $procedure_neck_desection }}  @if($procedure_neck_desection_specify != '') ({{ $procedure_neck_desection_specify }}) @endif, @endif
                @if($procedure_other != '') {{ $procedure_other }}  @if($procedure_other_specify != '') ({{ $procedure_other_specify }}) @endif, @endif
                @if($procedure_not_specified != '') {{ $procedure_not_specified }}, @endif
                </p>
            @endif
            @if($tumorsite_ox != '' || $tumorsite_nx != '' || $tumorsite_hx != ''  || $tumorsite_ns != '' || $tumorsite_ot != '' )
            <p><strong>Tumor Site:</strong>
            @if($tumorsite_ox != '') {{ $tumorsite_ox }}
            (@if($tumorsite_ox_pt != '')  {{ $tumorsite_ox_pt }}, @endif
            @if($tumorsite_ox_bt != '')  {{ $tumorsite_ox_bt }}, @endif
            @if($tumorsite_ox_st != '')  {{ $tumorsite_ox_st }}, @endif
            @if($tumorsite_ox_ul != '')  {{ $tumorsite_ox_ul }}, @endif
            @if($tumorsite_ox_pw != '')  {{ $tumorsite_ox_pw }} @endif), @endif
            @if($tumorsite_nx != '') {{ $tumorsite_nx }}  @if($tumorsite_nx_nt != '') ({{ $tumorsite_nx_nt }}) @endif, @endif
            @if($tumorsite_hx != '') {{ $tumorsite_hx }})
            (@if($tumorsite_hx_ps != '')  {{ $tumorsite_hx_ps }}, @endif
            @if($tumorsite_hx_pc != '')  {{ $tumorsite_hx_pc }}, @endif
            @if($tumorsite_hx_pw != '')  {{ $tumorsite_hx_pw }} @endif), @endif
            @if($tumorsite_ns != '') {{ $tumorsite_ns }} @endif
            @if($tumorsite_ot != '') {{ $tumorsite_ot }}  @if($tumorsite_ot_specify != '') ({{ $tumorsite_ot_specify }}) @endif, @endif
            @endif
            @if($tumorliterality != '')<p><strong>Tumor Laterality:</strong> {{ $tumorliterality }} @endif
            @if($tumorfocality != '')<p><strong>Tumor Focality:</strong> {{ $tumorfocality }}@endif
            @if($tumorsize_cd != '' || $tumorsize_gd != '')
            <p><strong>Tumor Size:</strong>@if($tumorsize_cd != '') Cannot be determined (explain): {{ $tumorsize_cd }} @else  Greatest dimension (centimeters): {{ $tumorsize_gd }}cm @if($tumorsize_length != '' && $tumorsize_width != '') => Additional dimensions (centimeters): {{ $tumorsize_length }}cm X {{ $tumorsize_width }}cm  @endif  @endif</p>
            @endif
            <p><strong>Histologic Type</strong></p>
            @if($histologic_cc_on != '')
            <p><strong><u>Carcinomas of the Oropharynx and Hypopharynx:</u></strong></p> {{ $histologic_cc_on }}
            @endif
            @if($histologic_sc_sc != '' || $histologic_sc_sn != '' || $histologic_sc_as != ''  || $histologic_sc_ac != '' || $histologic_sc_bs != '' || $histologic_sc_ps != '' || $histologic_sc_cc != '' || $histologic_sc_vs != '' || $histologic_sc_lc != '' )
            ...
            @endif
            @if($histologic_cn != '')
            <p><strong><u>Carcinomas of the Nasopharynx:</u></strong></p> {{ $histologic_cn }}
            @endif
            @if($histologic != '')
            ...
            <p><strong><u>Neuroendocrine Carcinoma:</u></strong></p>
                @if($histologic_nc == 'Other histologic type not listed (specify):' )
                    {{ $histologic_nc }} ({{ $histologic_explain }} )
                @else
                    {{ $histologic_nc }}
                @endif
            @endif
            ...
            @endif
            @if($tnm_descriptors_m != '' || $tnm_descriptors_r != '' || $tnm_descriptors_y != '' || $distance_metastasis != '' || $primary_m_tumor != '' || $distance_metastasis_m != '')<p><strong>Pathologic Stage Classification (pTNM, AJCC 8th Edition)</strong> <br/><i> Note: Reporting of pT, pN, and (when applicable) pM categories is based on information available to the pathologist at the time the report is issued. Only the applicable T, N, or M category is required for reporting; their definitions need not be included in the report. The categories (with modifiers when applicable) can be listed on 1 line or more than 1 line. </i></p>@endif
            ...
            @endif
            @if($primary_po_tumor != '' || $primary_no_tumor != '' || $primary_n_tumor != '' || $primary_t_tumor != '')
            <p><strong>For All Carcinomas</strong></p>
            <p><strong><u>Primary Tumor (pT)</u></strong></p>
            @if($primary_po_tumor != '')
            <p><em><i><b>For HPV-Mediated (Positive) Oropharynx:</b></i></em></p><span> {{ $primary_po_tumor }} </span></p>
            @endif
            @if($primary_no_tumor != '')
            <p><em><i><b>For HPV-Unrelated (Negative) Oropharynx:</b></i></em></p><span> {{ $primary_no_tumor }} </span></p>
            @endif
            @if($primary_n_tumor != '')
            <p><em><i><b>For Nasopharynx:</b></i></em></p><span> {{ $primary_n_tumor }} </span></p>
            @endif
            @if($primary_t_tumor != '')
            <p><em><i><b>For Hypopharynx:</b></i></em></p><span> {{ $primary_t_tumor }} </span></p>
            @endif
            @endif
            @if($rln_po != '' || $rln_no != '' || $rln_n != '')
            <p><strong>Regional Lymph Nodes (pN)</strong></p>
            @if($rln_po != '')
            <p><em><i><b>For HPV-Mediated (Positive) Oropharynx:</b></i></em></p><span> {{ $rln_po }} </span></p>
            @endif
            @if($rln_no != '')
            <p><em><i><b>For HPV-Unrelated (Negative) Oropharynx and Hypopharynx:</b></i></em></p><span> {{ $rln_no }} </span></p>
            @endif
            @if($rln_n != '')
            <p><em><i><b>For Nasopharynx:</b></i></em></p><span> {{ $rln_n }} </span></p>
            @endif
            @endif
            ...
            @if($primary_m_tumor != '')
            <p><strong><u>Primary Tumor (pT):</u></strong> {{ $primary_m_tumor }} </span></p>
            @endif
            @if($rln_m != '')
            <p><strong>Regional Lymph Nodes (pN)</strong> {{ $rln_m }} </span></p>
            @endif
            @if($distance_metastasis_m != '')<p><strong>Distance Metastasis: </strong><span> @if($distance_metastasis_m == 'pM1:  Distant metastasis') {{ $distance_metastasis_m}} @if($distance_metastasis_site_m != '') Specify site: {{ $distance_metastasis_site_m }} @endif @else {{ $distance_metastasis_m }} @endif </span></p>@endif
            @if($findings_ni != '' || $findings_sy != '' || $findings_ap != '' || $findings_sa != '' || $findings_mi != '' || $findings_mo != '' || $findings_sv != '' || $findings_ep != '' ||  $findings_cf != '' || $findings_cb != '' || $findings_if != '' || $findings_ot != '')
                <p><strong> Additional Pathologic Findings: </strong><span>{{ $findings_ni }} {{ $findings_sy }} {{ $findings_ap }} {{ $findings_sa }} {{ $findings_ss }}  {{ $findings_mi }}  {{ $findings_mo }}  {{ $findings_sv }}  {{ $findings_ep }}  {{ $findings_cf }}  {{ $findings_cb }}  {{ $findings_if }}({{ $findings_if_specify }}) {{ $findings_ot }} ({{ $findings_ot_specify }}) </span></p>
            @endif
            @if($ancillary_studies != '')<p><strong> Ancillary Studies: </strong><span> {{ $ancillary_studies_main }} </p> @endif

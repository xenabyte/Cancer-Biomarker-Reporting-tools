      ...
      <div id="exportContent" class="container">
        ...
        <div style="margin-bottom: 100px;" class="col-md-12">
            @if($procedure != '')
                ...
                @if($procedure == 'Partial gastrectomy')
                {{ $procedure }} @if($procedure_gas_other != '') ({{ $procedure_gas_other }}) @endif
                @elseif($procedure == 'Other (specify):')
                {{ $procedure }} ({{ $procedure_other }})
                @else
                {{ $procedure }}
                @endif</span></p>
            @endif
            @if($tumorsite_cd != '' || $tumorsite_fd != '' || $tumorsite_by != '' || $tumorsite_at != '' || $tumorsite_py != '' || $tumorsite_ns != '' || $tumorsite_ot != '' )
                <p><strong>Tumor Site:</strong><span>
                @if($tumorsite_cd != '') {{ $tumorsite_cd }}, @endif
                @if($tumorsite_fd != '') {{ $tumorsite_fd }}
                    @if($tumorsite_fd_aw != '') ({{ $tumorsite_fd_aw }}) @endif
                    @if($tumorsite_fd_pw != '') ({{ $tumorsite_fd_pw }}) @endif,
                @endif
                @if($tumorsite_by != '') {{ $tumorsite_by }}
                    @if($tumorsite_by_aw != '') ({{ $tumorsite_by_aw }}) @endif
                    @if($tumorsite_by_pw != '') ({{ $tumorsite_by_pw }}) @endif
                    @if($tumorsite_by_lc != '') ({{ $tumorsite_by_lc }}) @endif
                    @if($tumorsite_by_gc != '') ({{ $tumorsite_by_gc }}) @endif,
                @endif
                @if($tumorsite_at != '') {{ $tumorsite_at }}
                    @if($tumorsite_at_aw != '') ({{ $tumorsite_at_aw }}) @endif
                    @if($tumorsite_at_pw != '') ({{ $tumorsite_at_pw }}) @endif
                    @if($tumorsite_at_lc != '') ( {{ $tumorsite_at_lc }}) @endif
                    @if($tumorsite_at_gc != '') ({{ $tumorsite_at_gc }}) @endif,
                @endif
                @if($tumorsite_py != '') {{ $tumorsite_py }}, @endif
            ...
            @if($histologic != '')
                <p><strong>Histologic Type:</strong><span>
                   @if($histologic == 'Adenocarcinoma') {{ $histologic }}
                    <p><strong>Lauren classification of adenocarcinoma:</strong></p>
                    <div style="padding-left: 20px;">
                    @if($histologic_ad_in !='')<p>{{ $histologic_ad_in }} </p>@endif
                    @if($histologic_ad_dt !='')<p>{{ $histologic_ad_dt }} </p>@endif
                    @if($histologic_ad_ma !='')<p>{{ $histologic_ad_ma }} </p>@endif
                    </div>
                <p><strong> Alternative optional classification (based on WHO classification): </strong></p>
                    <div style="padding-left: 20px;">
                    @if($histologic_ao_ta !='')<p>{{ $histologic_ao_ta }} </p>@endif
                    @if($histologic_ao_pc !='')<p>{{ $histologic_ao_pc }} </p>@endif
                    @if($histologic_ao_ma !='')<p>{{ $histologic_ao_ma }} </p>@endif
                    @if($histologic_ao_pa !='')<p>{{ $histologic_ao_pa }} </p>@endif
                    </div>
            ...
            @if($tumor_extension != '')
                ...
                @if($tumor_extension == 'Tumor invades adjacent structures/organs') {{ $tumor_extension }} ({{ $tumor_extension_others }})   @else {{ $tumor_extension }}  @endif
                </span></p>
            @endif
            @if($icm != '')
            ...
            @endif
            @if($icm_distance != '')
                <p><strong>Distance of invasive carcinoma from closest margin(millimeters):</strong><span>{{ $icm_distance }} </span></p>
            @endif
            ...
            @endif
            @if($icm_ppm != '' || $icm_dpm != '' || $icm_opm != '' || $icm_om != '' )
            <h5><em><u>For gastrectomy specimens only:</u></em></h5>
            @endif
            @if($icm_ppm != '')
                <p><strong>Proximal Margin:</strong><span>
                @if($icm_ppm == 'Uninvolved by invasive carcinoma')
                {{ $icm_ppm }} @if($icm_ppm_other != '') ({{ $icm_ppm_other }}) @endif
                @else
                {{ $icm_pppm }}
                @endif
                </span></p>
            ...
            @if($icm_dpm != '')
                ...
                @if($icm_dpm == 'Uninvolved by invasive carcinoma')
                {{ $icm_dpm }} @if($icm_dpm_other != '') ({{ $icm_dpm_other }}) @endif
                @else
                {{ $icm_dpm }}
                @endif
                </span></p>
            ...
            @if($icm_opm != '')
                ...
                @if($icm_opm == 'Uninvolved by invasive carcinoma')
                {{ $icm_opm }} @if($icm_opm_other != '') ({{ $icm_opm_other }}) @endif
                @else
                {{ $icm_opm }}
                @endif
                </span></p>
            ...
            @if($icm_mpm != '')
                ...
                @if($icm_mpm == 'Uninvolved by invasive carcinoma')
                {{ $icm_mpm }} @if($icm_mpm_other != '') ({{ $icm_mpm_other }}) @endif
                @else
                {{ $icm_mpm }}
                @endif
            @endif
            ...
            @if($findings_ni != '' || $findings_im != '' || $findings_lg != '' || $findings_hg != '' || $findings_hp != '' || $findings_aa != '' || $findings_po != '' || $findings_ot != '' )
                <p><strong>Additional Pathologic Findings:</strong><span>
                @if($findings_ni != '') {{ $findings_ni }}, @endif
                @if($findings_im != '') {{ $findings_im }}, @endif
                @if($findings_lg != '') {{ $findings_lg }}, @endif
                @if($findings_hg != '') {{ $findings_hg }}, @endif
                @if($findings_hp != '') {{ $findings_hp }}, @endif
                @if($findings_aa != '') {{ $findings_aa }}, @endif
                @if($findings_po != '') {{ $findings_po }} (@if($findings_po_specify != '') {{ $findings_po_specify }}), @endif @endif

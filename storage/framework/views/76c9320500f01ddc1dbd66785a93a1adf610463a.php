    ...
    <section>
      <div class="container">
		...
		<hr>
		 ...
		 <form action="<?php echo e(route('msg.preview')); ?>" method="POST">
		 <?php echo csrf_field(); ?>
        <div class="row">
          <div class="col-md-12">
...
<?php /* C:\Users\DELL INSPIRON 15\Desktop\Laravel Projects\CBReporting\resources\views/major_salivary_glands.blade.php */ ?>
    ...
    <section>
      <div class="container">
		...
		<hr>
		 ...
		 <form action="<?php echo e(route('loc.preview')); ?>" method="POST">
		 <?php echo csrf_field(); ?>
...
<?php /* C:\Users\DELL INSPIRON 15\Desktop\Laravel Projects\CBReporting\resources\views/lip_oral_cavity.blade.php */ ?>
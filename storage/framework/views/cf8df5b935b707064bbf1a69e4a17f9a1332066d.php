  ...
  <div class="main-content">
    ...
    <section>
      <div id="exportContent" class="container">
        ...
        <div class="col-md-12">
            <?php if($procedure_excision != '' || $procedure_glo != '' || $procedure_bmr != '' || $procedure_mmy != '' || $procedure_mxy != '' || $procedure_palatectomy != ''  || $procedure_neck_desection != '' || $procedure_other != '' || $procedure_not_specified != '' ): ?>
                <p><strong>Procedure:</strong><span>
                <?php if($procedure_other != ''): ?> <?php echo e($procedure_other); ?> (<?php echo e($procedure_other_specify); ?>) <?php endif; ?>
                <?php if($procedure_neck_desection != ''): ?> <?php echo e($procedure_neck_desection); ?> (<?php echo e($procedure_neck_desection_specify); ?>) <?php endif; ?>
                <?php if($procedure_bmr != ''): ?> <?php echo e($procedure_bmr); ?> (<?php echo e($procedure_bmr_specify); ?>) <?php endif; ?>
                <?php if($procedure_glo != ''): ?> <?php echo e($procedure_glo); ?> (<?php echo e($procedure_glo_specify); ?>) <?php endif; ?>
                <?php if($procedure_mmy != ''): ?> <?php echo e($procedure_mmy); ?> (<?php echo e($procedure_mmy_specify); ?>) <?php endif; ?>
                <?php if($procedure_mxy != ''): ?> <?php echo e($procedure_mxy); ?> (<?php echo e($procedure_mxy_specify); ?>) <?php endif; ?>
                <?php if($procedure_palatectomy != ''): ?> <?php echo e($procedure_palatectomy); ?>  <?php endif; ?>
            ...
            <?php endif; ?>
            <?php if($tumorsite_lp != '' || $tumorsite_ol != '' || $tumorsite_ns != '' || $tumorsite_ot != ''): ?>
                <p><strong>Tumor Site:</strong><span>
                <?php if($tumorsite_lp != ''): ?> <?php echo e($tumorsite_lp); ?>

                    <?php if($tumorsite_lp_ul != ''): ?> (<?php echo e($tumorsite_lp_ul); ?>), <?php endif; ?>
                    <?php if($tumorsite_lp_ll != ''): ?> (<?php echo e($tumorsite_lp_ll); ?>), <?php endif; ?>
                <?php endif; ?>
                <?php if($tumorsite_ol != ''): ?> <?php echo e($tumorsite_ol); ?>

                    <?php if($tumorsite_ol_lbt != ''): ?> (<?php echo e($tumorsite_ol_lbt); ?>), <?php endif; ?>
                    <?php if($tumorsite_ol_vst != ''): ?> (<?php echo e($tumorsite_ol_vst); ?>), <?php endif; ?>
                    <?php if($tumorsite_ol_dst != ''): ?> (<?php echo e($tumorsite_ol_dst); ?>), <?php endif; ?>
                    <?php if($tumorsite_ol_att != ''): ?> (<?php echo e($tumorsite_ol_att); ?>), <?php endif; ?>
                    <?php if($tumorsite_ol_upg != ''): ?> (<?php echo e($tumorsite_ol_upg); ?>), <?php endif; ?>
                    <?php if($tumorsite_ol_lwg != ''): ?> (<?php echo e($tumorsite_ol_lwg); ?>), <?php endif; ?>
                    <?php if($tumorsite_ol_ptc != ''): ?> (<?php echo e($tumorsite_ol_ptc); ?>), <?php endif; ?>
                    <?php if($tumorsite_ol_afm != ''): ?> (<?php echo e($tumorsite_ol_afm); ?>), <?php endif; ?>
                    <?php if($tumorsite_ol_frm != ''): ?> (<?php echo e($tumorsite_ol_frm); ?>), <?php endif; ?>
                    <?php if($tumorsite_ol_hdp != ''): ?> (<?php echo e($tumorsite_ol_hdp); ?>), <?php endif; ?>
                    <?php if($tumorsite_ol_bcm != ''): ?> (<?php echo e($tumorsite_ol_bcm); ?>), <?php endif; ?>
                    <?php if($tumorsite_ol_vmm != ''): ?> (<?php echo e($tumorsite_ol_vmm); ?>), <?php endif; ?>
                    <?php if($tumorsite_ol_vmr != ''): ?> (<?php echo e($tumorsite_ol_vmr); ?>), <?php endif; ?>
                    <?php if($tumorsite_ol_apm != ''): ?> (<?php echo e($tumorsite_ol_apm); ?>), <?php endif; ?>
                    <?php if($tumorsite_ol_apr != ''): ?> (<?php echo e($tumorsite_ol_apr); ?>), <?php endif; ?>
                    <?php if($tumorsite_ol_rla != ''): ?> (<?php echo e($tumorsite_ol_rla); ?>), <?php endif; ?>
                <?php endif; ?>
                <?php if($tumorsite_ns != ''): ?> <?php echo e($tumorsite_ns); ?>  <?php endif; ?>
                <?php if($tumorsite_ot != ''): ?> <?php echo e($tumorsite_ot); ?>

                    <?php if($tumorsite_ot_specify != ''): ?> (<?php echo e($tumorsite_ot_specify); ?>), <?php endif; ?>
                <?php endif; ?>
                </span></p>
            <?php endif; ?>
            <?php if($tumorliterality != ''): ?>
                <p><strong>Tumor Laterality:</strong><span> <?php echo e($tumorliterality); ?> </span></p>
            <?php endif; ?>
            <?php if($tumorfocality != ''): ?>
                <p><strong>Tumor Focality:</strong><span> <?php echo e($tumorfocality); ?> </span></p>
            <?php endif; ?>
            <?php if($tumorsize_gd != '' || $tumorsize_cd != ''): ?>
                <p><strong>Tumor Size:</strong><span><?php if($tumorsize_cd != ''): ?> Cannot be determined (explain): <?php echo e($tumorsize_cd); ?> <?php else: ?>  Greatest dimension (centimeters): <?php echo e($tumorsize_gd); ?>cm <?php if($tumorsize_length != '' && $tumorsize_width != ''): ?> => Additional dimensions (centimeters): <?php echo e($tumorsize_length); ?>cm X <?php echo e($tumorsize_width); ?>cm  <?php endif; ?>  <?php endif; ?></span></p>
            <?php endif; ?>
            <?php if($tumordepth != ''): ?>
                <p><strong>Tumor Depth of Invasion (DOI) (millimeters):</strong><span> <?php echo e($tumordepth); ?> mm </span></p>
            <?php endif; ?>
            <?php if($histologic != ''): ?>
                ...
                <?php if($histologic_sc_ca != ''): ?> <?php echo e($histologic_sc_ca); ?>, <?php endif; ?>
                ...
                <?php elseif($histologic == 'Combined (or composite) neuroendocrine carcinoma with (specify types)'): ?>
                 <?php echo e($histologic); ?>: <?php echo e($histologic_cn_type); ?>
            ...
            <?php endif; ?>
            <?php if($tumor_bed != ''): ?>
                <p><strong>Tumor Bed Margin Orientation: </strong><span> <?php echo e($tumor_bed); ?> </span></p>
            <?php endif; ?>
            <?php if($icm_tumorbed != ''): ?>
                <p><strong>Tumor Bed (Separately Submitted) Margins:</strong><span>
                <?php if($icm_tumorbed == 'Uninvolved by invasive tumor'): ?> <?php echo e($icm); ?>

                    <?php if($icm_tumorbed_location_specify != ''): ?> (Specify distance to true margin surface (millimeters): <?php echo e($icm_location_specify); ?>) <?php endif; ?>
                <?php elseif($icm == "Involved by invasive tumor"): ?>
                    <?php if($icm_tumorbed_involve_distance_specify != ''): ?> (Specify margin(s), per part labeling: <?php echo e($icm_involve_distance_specify); ?>) <?php endif; ?>
                <?php elseif($icm == "Uninvolved by high-grade dysplasia/in situ disease"): ?>
                    <?php if($icm_tumorbed_location_specify != ''): ?> (Specify distance to true margin surface (millimeters): <?php echo e($icm_location_specify); ?>) <?php endif; ?>
                <?php elseif($icm == "Involved by high-grade dysplasia/in situ disease"): ?>
                    <?php if($icm_tumorbed_involve_distance_specify != ''): ?> (Specify margin(s), per orientation: <?php echo e($icm_involve_distance_specify); ?>) <?php endif; ?>
                <?php else: ?>
                    <?php echo e($icm); ?>
            ...
            <?php endif; ?>
            <?php if($wpoi != ''): ?>
                <p><strong>Worst Pattern of Invasion (WPOI):</strong> <?php echo e($wpoi); ?> <span></span></p>
            <?php endif; ?>
            <?php if($ln != ''): ?>
            ...
            <?php if($primary_tumor != '' || $primary_m_tumor != ''): ?>
            ...
            <?php endif; ?>
            <?php if($primary_m_tumor != ''): ?><p><strong>Primary Tumor: </strong><span> <?php echo e($primary_m_tumor); ?> </span></p><?php endif; ?>
            <?php if($rln_m != ''): ?><p><strong>Regional Lymph Nodes (pN) : </strong><span> <?php echo e($rln_m); ?> </span></p><?php endif; ?>
            <?php if($distance_metastasis_m != ''): ?><p><strong>Distance Metastasis: </strong><span> <?php if($distance_metastasis_m == 'pM1:  Distant metastasis'): ?> <?php echo e($distance_metastasis); ?> <?php if($distance_metastasis_site_m != ''): ?> Specify site: <?php echo e($distance_metastasis_site); ?> <?php endif; ?> <?php else: ?> <?php echo e($distance_metastasis_m); ?> <?php endif; ?> </span></p><?php endif; ?>
            <?php if($findings_ni != '' || $findings_sy != '' || $findings_sa != '' || $findings_ss != '' || $findings_mi != '' || $findings_mo != '' || $findings_sv != '' || $findings_ep != '' || $findings_cf != '' || $findings_if != '' || $findings_cb != '' || $findings_ot != '' ): ?>
                <p><strong>Additional Pathologic Findings:</strong><span>
                <?php if($findings_ni != ''): ?> <?php echo e($findings_ni); ?>, <?php endif; ?>
                <?php if($findings_sy != ''): ?> <?php echo e($findings_sy); ?>, <?php endif; ?>
                <?php if($findings_sa != ''): ?> <?php echo e($findings_sa); ?>, <?php endif; ?>
                <?php if($findings_ss != ''): ?> <?php echo e($findings_ss); ?>, <?php endif; ?>
                <?php if($findings_mi != ''): ?> <?php echo e($findings_mi); ?>, <?php endif; ?>
                <?php if($findings_mo != ''): ?> <?php echo e($findings_mo); ?>, <?php endif; ?>
                <?php if($findings_sv != ''): ?> <?php echo e($findings_sv); ?>, <?php endif; ?>
                <?php if($findings_ep != ''): ?> <?php echo e($findings_ep); ?>, <?php endif; ?>
                <?php if($findings_cf != ''): ?> <?php echo e($findings_cf); ?>, <?php endif; ?>
                <?php if($findings_cb != ''): ?> <?php echo e($findings_cb); ?>, <?php endif; ?>
                <?php if($findings_if != ''): ?> <?php echo e($findings_if); ?> (<?php if($findings_if_specify != ''): ?> <?php echo e($findings_if_specify); ?>), <?php endif; ?> <?php endif; ?>
...
<?php /* C:\Users\DELL INSPIRON 15\Desktop\Laravel Projects\CBReporting\resources\views/preview_loc.blade.php */ ?>

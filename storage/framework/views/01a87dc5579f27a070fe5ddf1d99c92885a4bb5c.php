  ...
  <div class="main-content">
    ...
    <section>
      <div id="exportContent" class="container">
        ...
        <div class="col-md-12">
            <?php if($procedure_excision != '' || $procedure_endo_excision != '' || $procedure_laser_excision != '' || $procedure_supra_laryn != '' || $procedure_coid_laryn != '' || $procedure_total_laryn != '' || $procedure_ver_hemi != '' || $procedure_par_laryn != '' || $procedure_neck_desection != '' || $procedure_other != '' || $procedure_not_specified != '' ): ?>
                ...
                <?php if($procedure_par_laryn != ''): ?> <?php echo e($procedure_par_laryn); ?> (<?php echo e($procedure_res_subman); ?>) <?php endif; ?>
                <?php if($procedure_ver_hemi != ''): ?> <?php echo e($procedure_ver_hemi); ?> (<?php echo e($procedure_ver_hemi_specify); ?>) <?php endif; ?>
                <?php if($procedure_total_laryn != ''): ?> <?php echo e($procedure_total_laryn); ?>  <?php endif; ?>
                <?php if($procedure_coid_laryn != ''): ?> <?php echo e($procedure_coid_laryn); ?>  <?php endif; ?>
                <?php if($procedure_supra_laryn != ''): ?> <?php echo e($procedure_supra_laryn); ?>  <?php endif; ?>
                <?php if($procedure_laser_excision != ''): ?> <?php echo e($procedure_laser_excision); ?>  <?php endif; ?>
                <?php if($procedure_endo_excision != ''): ?> <?php echo e($procedure_endo_excision); ?>  <?php endif; ?>
                <?php if($procedure_excision != ''): ?> <?php echo e($procedure_excision); ?>  <?php endif; ?>
                </span></p>
            <?php endif; ?>
            <?php if($tumorsite_ls != '' || $tumorsite_lg != '' || $tumorsite_gb != '' || $tumorsite_ns != '' || $tumorsite_ot != ''): ?>
                <p><strong>Tumor Site:</strong><span>
                <?php if($tumorsite_ls != ''): ?> <?php echo e($tumorsite_ls); ?>

                    <?php if($tumorsite_ls_ea != ''): ?> (<?php echo e($tumorsite_ls_ea); ?>), <?php endif; ?>
                    <?php if($tumorsite_ls_el != ''): ?> (<?php echo e($tumorsite_ls_el); ?>), <?php endif; ?>
                    <?php if($tumorsite_ls_af != ''): ?> (<?php echo e($tumorsite_ls_af); ?>), <?php endif; ?>
                    <?php if($tumorsite_ls_ar != ''): ?> (<?php echo e($tumorsite_ls_ar); ?>), <?php endif; ?>
                    <?php if($tumorsite_ls_fv != ''): ?> (<?php echo e($tumorsite_ls_fv); ?>), <?php endif; ?>
                    <?php if($tumorsite_ls_vn != ''): ?> (<?php echo e($tumorsite_ls_vn); ?>), <?php endif; ?>
                <?php endif; ?>
                <?php if($tumorsite_lg != ''): ?> <?php echo e($tumorsite_lg); ?>

                    <?php if($tumorsite_lg_vv != ''): ?> (<?php echo e($tumorsite_lg_vv); ?>), <?php endif; ?>
                    <?php if($tumorsite_lg_ac != ''): ?> (<?php echo e($tumorsite_lg_ac); ?>), <?php endif; ?>
                    <?php if($tumorsite_lg_pc != ''): ?> (<?php echo e($tumorsite_lg_pc); ?>), <?php endif; ?>
                    <?php if($tumorsite_lg_se != ''): ?> (<?php echo e($tumorsite_lg_se); ?>), <?php endif; ?>
                <?php endif; ?>
                <?php if($tumorsite_gb != ''): ?> <?php echo e($tumorsite_gb); ?>  <?php endif; ?>
            ...
            <?php endif; ?>
            <?php if($transglottic_extension != ''): ?>
                <p><strong>Transglottic Extension:</strong><span> <?php echo e($transglottic_extension); ?> </span></p>
            <?php endif; ?>
            ...
            <?php if($primary_s_tumor != ''): ?><p><span> <?php echo e($primary_s_tumor); ?> </span></p><?php endif; ?>
            <p><em><i><b>For the Glottis</b></i></em></p>
            <?php if($primary_g_tumor != ''): ?><p><span> <?php echo e($primary_g_tumor); ?> </span></p><?php endif; ?>
            <p><em><i><b>For the Subglottis</b></i></em></p>
            <?php if($primary_t_tumor != ''): ?><p><span> <?php echo e($primary_t_tumor); ?> </span></p><?php endif; ?>
            ...
            <?php if($findings_ni != '' || $findings_dl != '' || $findings_ap != '' || $findings_sp != '' || $findings_st != '' || $findings_if != '' || $findings_cf != '' || $findings_if != '' || $findings_cb != '' || $findings_ot != '' ): ?>
                <p><strong>Additional Pathologic Findings:</strong><span>
                <?php if($findings_ni != ''): ?> <?php echo e($findings_ni); ?>, <?php endif; ?>
                <?php if($findings_dl != ''): ?> <?php echo e($findings_dl); ?>, <?php endif; ?>
                <?php if($findings_ap != ''): ?> <?php echo e($findings_ap); ?>, <?php endif; ?>
                <?php if($findings_sp != ''): ?> <?php echo e($findings_sp); ?>, <?php endif; ?>
                <?php if($findings_st != ''): ?> <?php echo e($findings_st); ?>, <?php endif; ?>
                <?php if($findings_sm != ''): ?> <?php echo e($findings_sm); ?>, <?php endif; ?>
...
<?php /* C:\Users\DELL INSPIRON 15\Desktop\Laravel Projects\CBReporting\resources\views/preview_lyx.blade.php */ ?>

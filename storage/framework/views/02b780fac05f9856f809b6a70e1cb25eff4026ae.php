...
<div id="wrapper" class="clearfix">
  ...
  <div class="main-content">
      ...
      <div class="container">
		<div Style="padding: 10px;" class="row">
			...
			<h1>Surgical Pathology Cancer Case Summary</h1>
			  ...
			  <h4 class="heading-title">COLON AND RECTUM: Excisional Biopsy (Polypectomy)</h4>
			  <p>Select a single response unless otherwise indicated.</p>
			</div>
		</div>
		<hr>

		 <form action="<?php echo e(route('cre.preview')); ?>" method="POST">
		 <?php echo csrf_field(); ?>
    ...
    <div class="heading-line-bottom">
        <h4 class="heading-title">Specimen Integrity </h4>
    </div>
    <div class="row">
        <div class="form-group col-md-4">
            <input type="radio" name="specimen_integrity" value="Intact" class=""> Intact
        </div>
        <div class="form-group col-md-4">
            <input type="radio" name="specimen_integrity" value="Fragmented" class=""> Fragmented
        </div>
    </div>


    <div class="heading-line-bottom">
        <h4 class="heading-title">Polyp Size </h4>
    </div>
    <div class="row">
        <div class="form-group col-md-6">
            Greatest dimension (centimeters): <input type="text" name="polypsize_gd" class="form-control"><br/>
            <h5>Additional dimensions (centimeters):<h5>
            <div class="row">
                <div class="form-group col-md-2">
                    <input type="text" name="polypsize_length" class="form-control">
                </div>
                <div class="form-group col-md-2">
                    <p style="padding: 10px;" class="text-center"> X </p>
                </div>
                <div class="form-group col-md-2">
                    <input type="text" name="polypsize_width" class="form-control">
                </div>
            </div>
        </div>
        <div class="form-group col-md-6">
            Cannot be determined (explain): <input type="text" name="polypsize_cd" class="form-control">
        </div>
    </div>

    <div class="heading-line-bottom">
        <h4 class="heading-title">Polyp Configuration </h4>
    </div>
    <div class="row">
        <div class="form-group col-md-4">
            <input type="radio" name="polyconfig" value="Pedunculated with stalk" class=""> Pedunculated with stalk <br/>
            Stalk length (centimeters): <input type="text" name="polyconfig_pedun" class="form-control">
        </div>
        <div class="form-group col-md-4">
            <input type="radio" name="polyconfig" value="Sessile"> Sessile
        </div>
    </div>


    <div class="heading-line-bottom">
        <h4 class="heading-title">Size of Invasive Carcinoma </h4>
    </div>
    <div class="row">
        <div class="form-group col-md-6">
            Greatest dimension (centimeters): <input type="text" name="sic_gd" class="form-control"><br/>
            <h5>Additional dimensions (centimeters):<h5>
            <div class="row">
                <div class="form-group col-md-2">
                    <input type="text" name="sic_length" class="form-control">
                </div>
                <div class="form-group col-md-2">
                    <p style="padding: 10px;" class="text-center"> X </p>
                </div>
                <div class="form-group col-md-2">
                    <input type="text" name="sic_width" class="form-control">
                </div>
            </div>
        </div>
        <div class="form-group col-md-6">
            Cannot be determined (explain): <input type="text" name="sic_cd" class="form-control">
        </div>
    </div>
			...
			<div class="heading-line-bottom">
			 ...
			 <!-- Modal -->
              <div class="modal fade" id="myModal1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
			   ...
			   <div class="row">
                <div class="form-group col-md-4">
                  <input type="radio" name="tumor_extension" value="Tumor invades lamina propria " class=""> Tumor invades lamina propria
                </div>
				<div class="form-group col-md-4">
                  <input type="radio" name="tumor_extension" value="Tumor invades muscularis mucosae " class="">  Tumor invades muscularis mucosae
                </div>
				<div class="form-group col-md-4">
	...
	<div class="row">
		<div class="col-md-12">
			<div class="heading-line-bottom">
			  ...
			  <h4 class="heading-title">Deep Margin (Stalk Margin)</h4>
			  <hr>
			  <div class="row">
                  ...
                  <input type="radio" name="icm" value="Uninvolved by invasive carcinoma" class=""> Uninvolved by invasive carcinoma
					 <div style="margin-left: 50px;" class="row">
						<div class="form-group">
						   <p><strong>Distance of invasive carcinoma from margin(millimeters) </strong><br/><input type="text" name="icm_closest_margin" placeholder="closest margin ___mm " class="form-control"></p>
						</div>
					</div>
                </div>
                <div class="form-group col-md-12">
            ...
            <div class="row">
                ...
                <div class="form-group col-md-12">
                  <input type="radio" name="icm_mm" value="Involved by adenoma" class=""> Involved by adenoma
                </div>
            </div>
			</div>
        </div>
...
<?php /* C:\Users\DELL INSPIRON 15\Desktop\Laravel Projects\CBReporting\resources\views/colon_rectum_excisional.blade.php */ ?>
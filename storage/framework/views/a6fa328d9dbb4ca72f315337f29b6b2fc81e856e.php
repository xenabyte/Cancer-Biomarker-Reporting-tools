...
<div id="wrapper" class="clearfix">
  ...
  <div class="main-content">
      ...
      <div class="container">
		<div Style="padding: 10px;" class="row">
			...
			<h1>Surgical Pathology Cancer Case Summary</h1>
			  ...
			  <h4 class="heading-title">INVASIVE CARCINOMA OF THE BREAST: Resection</h4>
			  <p>Select a single response unless otherwise indicated.</p>
			</div>
		</div>
		<hr>

		 <form action="<?php echo e(route('bir.preview')); ?>" method="POST">
		 <?php echo csrf_field(); ?>
        <div class="row">
          <div class="col-md-12">
            <div class="heading-line-bottom">
              <h4 class="heading-title">Procedure <a href="#" data-toggle="modal" data-target="#myModal2"><i class="fa fa-question-circle"></i></a><code>*</code> </h4>
				<!-- Modal -->
		  ...
		  <div class="row">
			<div class="form-group col-md-6">
			  <input type="radio" name="procedure" value="Excision (less than total mastectomy)" class="" notrequired> Excision (less than total mastectomy)
			</div>
			<div class="form-group col-md-6">
			  <input type="radio" name="procedure" value="Total mastectomy (including nipple-sparing and skin-sparing mastectomy)" class=""> Total mastectomy (including nipple-sparing and skin-sparing mastectomy)
			</div>
			 <div class="form-group col-md-6">
			  <input type="radio" name="procedure" value="Not specified" class=""> Not specified
			</div>
			 <div class="form-group col-md-6">
			    <input type="radio" name="procedure" value="Other" class=""> Other
			  <label>Other(Specify)</label>
			  <input type="text" name="procedure_other" placeholer="Specify" class="form-control">
			</div>
		  </div>


		 <h4 class="heading-title">Specimen Laterality<code>*</code></h4>
		 <hr>

		  <div class="row">
			<div class="form-group col-md-6">
			  <input type="radio" name="specimenl" value="Right" class="" notrequired> Right
			</div>
			<div class="form-group col-md-6">
			  <input type="radio" name="specimenl" value="Left" class=""> Left
			</div>
			 <div class="form-group col-md-6">
			  <input type="radio" name="specimenl" value="Right and Left" class=""> Right and Left
			</div>
			 <div class="form-group col-md-6">
			  <input type="radio" name="specimenl" value="Not specified" class=""> Not specified
			</div>
		  </div>
		</div>
	</div>
	...
	<div class="row">
		<div class="col-md-12">
			<div class="heading-line-bottom">
			  <h4 class="heading-title">Tumor Site (select all that apply, as appropriate) <a href="#" data-toggle="modal" data-target="#myModal3"><i class="fa fa-question-circle"></i></a>
			  <br/> This section is optional
			  </h4>
			 </div>
			 ...
			 <!-- Modal -->
			  ...
			  <div class="row">
					<div class="form-group col-md-6">
						<input type="checkbox" name="tumorsite_upper_outer" value="Upper outer quadrant" class=""> Upper outer quadrant
					</div>
					<div class="form-group col-md-6">
						<input type="checkbox" name="tumorsite_lower_outer" value="Lower outer quadrant" class=""> Lower outer quadrant
					</div>
				 	<div class="form-group col-md-6">
						<input type="checkbox" name="tumorsite_upper_inner" value="Upper inner quadrant" class=""> Upper inner quadrant
					</div>
					<div class="form-group col-md-6">
             <input type="checkbox" name="tumorsite_lower_inner" value="Lower inner quadrant" class=""> Lower inner quadrant
          </div>
          <div class="form-group col-md-6">
						<input type="checkbox" name="tumorsite_central" value="Central" class=""> Central
					</div>
				  <div class="form-group col-md-6">
						<input type="checkbox" name="tumorsite_nipple" value="Nipple" class=""> Nipple
					</div>
				  <div class="form-group col-md-6">
						<input type="checkbox" name="tumorsite_notspecified" value="Not Specified" class=""> Not Specified
					</div>
				  <div class="form-group col-md-6">
				 		<input type="checkbox" name="tumorsite_clock" value="Clock position: " class=""> Clock position (specify):
						<input type="text" name="tumorsite_clock_position" placeholder="Clock position (specify):" class="form-control">
					</div>
				 	<div class="form-group col-md-6">
				 		<input type="checkbox" name="tumorsite_distance_fromnipple" value="Distance from nipple (centimeters): " class=""> Distance from nipple (centimeters):
						 <input type="text" style="width: 30%;" name="tumorsite_distance_realdistance" placeholder="Distance from nipple (centimeters):" class="form-control">
					</div>
				  <div class="form-group col-md-6">
				  	<input type="checkbox" name="tumorsite_other" value="Other: " class=""> Other (specify):
						<input type="text" name="tumorsite_specify" placeholder="Other (specify):" class="form-control">
					</div>
      </div>
		</div>
	</div>
	...
	<div class="row">
		<div class="col-md-12">
			<div class="heading-line-bottom">
			  <h4 class="heading-title">Tumor Size <a href="#" data-toggle="modal" data-target="#myModal4"><i class="fa fa-question-circle"></i></a><code>*</code></h4>
			 </div>
			 ...
			 <!-- Modal -->
                ...
                <div class="modal-dialog modal-lg" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <p><strong>Excisions:</strong> These procedures resect breast tissue without the intent of removing the entire breast. The nipple is usually not included with excisions. Excisions include specimens designated “partial mastectomies,” “lumpectomies,” and “quadrantectomies.”<br/>
                      <p><img src="reporting_images/tumor_size1.png"  class="img-responsive" /></p>
			  ...
			  <div class="row">
                <div class="form-group col-md-6">
                  <input type="radio" name="tumorsize" value="Microinvasion only (≤1 mm)" class="" notrequired> Microinvasion only (≤1 mm)
                </div>
				 <div class="form-group col-md-6">
                  <input type="radio" name="tumorsize" value="No residual invasive carcinoma" class=""> No residual invasive carcinoma
                </div>
                <div class="form-group col-md-6">
				<input type="radio" name="tumorsize" value="Greatest dimension of largest invasive focus >1 mm: " class=""> Greatest dimension of largest invasive focus >1 mm (specify exact measurement)
				<input type="text" style="width: 30%" name="tumorsize_gmlength" class="form-control">
				<h6>Additional Dimension (All measurements are in mm)</h6>
				  <div class="row">
					<div class="form-group col-md-5">
					  <input style="width: 30%" type="text" name="tumorsize_length" class="form-control">
					</div>
					<div class="form-group col-md-2">
					  <p style="padding: 10px;" class="text-center"> X </p>
					</div>
					<div class="form-group col-md-5">
					  <input style="width: 30%" type="text" name="tumorsize_width" class="form-control">
					</div>
				  </div>
				 </div>
				<div class="form-group col-md-6">
				  <input type="radio" name="tumorsize" value="Size of largest invasive focus cannot be determined" class=""> Size of largest invasive focus cannot be determined
                  <textarea name="tumorsize_explain" Placeholder="Please Explain" col="5" row="10" class="form-control"></textarea>
                </div>
              </div>
		</div>
	</div>
		...
		<div class="col-md-12">
			<div class="heading-line-bottom">
			 ...
			 <!-- Modal -->
			  ...
			  <div class="row">
                <div class="form-group col-md-6">
                  <input type="radio" name="histologic" value="No residual invasive carcinoma " class="" notrequired> No residual invasive carcinoma
                </div>
				 <div class="form-group col-md-6">
                  <input type="radio" name="histologic" value="Invasive carcinoma of no special type (invasive ductal carcinoma, not otherwise specified)" class=""> Invasive carcinoma of no special type (invasive ductal carcinoma, not otherwise specified)
                </div>
				<div class="form-group col-md-6">
                  <input type="radio" name="histologic" value="Micro-invasive carcinoma " class=""> Micro-invasive carcinoma
                </div>
				 <div class="form-group col-md-6">
                  <input type="radio" name="histologic" value="Invasive lobular carcinoma" class=""> Invasive lobular carcinoma
                </div>
				<div class="form-group col-md-6">
                  <input type="radio" name="histologic" value="Invasive carcinoma with lobular features " class=""> Invasive carcinoma with lobular features
                </div>
				 <div class="form-group col-md-6">
                  <input type="radio" name="histologic" value="Invasive carcinoma with ductal and lobular features (“mixed type carcinoma”)" class=""> Invasive carcinoma with ductal and lobular features (“mixed type carcinoma”)
                </div>
				<div class="form-group col-md-6">
                  <input type="radio" name="histologic" value="Mucinous carcinoma " class=""> Mucinous carcinoma
                </div>
				 <div class="form-group col-md-6">
                  <input type="radio" name="histologic" value="Tubular carcinoma" class=""> Tubular carcinoma
                </div>
               <div class="form-group col-md-6">
                  <input type="radio" name="histologic" value="Invasive carcinoma, tubulo-lobular variant " class=""> Invasive carcinoma, tubulo-lobular variant
                </div>
				 <div class="form-group col-md-6">
                  <input type="radio" name="histologic" value="Invasive cribriform carcinoma" class=""> Invasive cribriform carcinoma
                </div>
				<div class="form-group col-md-6">
                  <input type="radio" name="histologic" value="Invasive papillary carcinoma " class=""> Invasive papillary carcinoma
                </div>
				 <div class="form-group col-md-6">
                  <input type="radio" name="histologic" value="Invasive carcinoma with medullary features" class=""> Invasive carcinoma with medullary features
                </div>
				<div class="form-group col-md-6">
                  <input type="radio" name="histologic" value="Metaplastic carcinoma  " class=""> Metaplastic carcinoma
                </div>
				 <div class="form-group col-md-6">
                  <input type="radio" name="histologic" value="Fibromatosis-like metaplastic carcinoma " class=""> Fibromatosis-like metaplastic carcinoma
				 </div>
				<div class="form-group col-md-6">
                  <input type="radio" name="histologic" value="Metaplastic carcinoma, spindle cell type " class=""> Metaplastic carcinoma, spindle cell type
                </div>
				 <div class="form-group col-md-6">
                  <input type="radio" name="histologic" value="Metaplastic carcinoma, mixed epithelial and mesenchymal type" class=""> Metaplastic carcinoma, mixed epithelial and mesenchymal type
                </div>
				<div class="form-group col-md-6">
                  <input type="radio" name="histologic" value="Invasive carcinoma with metaplastic features " class=""> Invasive carcinoma with metaplastic features
                </div>
				 <div class="form-group col-md-6">
                  <input type="radio" name="histologic" value="Squamous cell carcinoma" class=""> Squamous cell carcinoma
                </div>
				<div class="form-group col-md-6">
                  <input type="radio" name="histologic" value="Adenoid cystic carcinoma  " class=""> Adenoid cystic carcinoma
                </div>
				 <div class="form-group col-md-6">
                  <input type="radio" name="histologic" value="Invasive carcinoma with apocrine features " class=""> Invasive carcinoma with apocrine features
				 </div>

				  <div class="form-group col-md-6">
                  <input type="radio" name="histologic" value="Invasive carcinoma with clear cell (glycogen rich) features " class=""> Invasive carcinoma with clear cell (glycogen rich) features
				 </div>
				<div class="form-group col-md-6">
                  <input type="radio" name="histologic" value="Invasive carcinoma with neuroendocrine features " class=""> Invasive carcinoma with neuroendocrine features
                </div>
				 <div class="form-group col-md-6">
                  <input type="radio" name="histologic" value="Invasive carcinoma, with signet-ring cell features" class=""> Invasive carcinoma, with signet-ring cell features
                </div>
				<div class="form-group col-md-6">
                  <input type="radio" name="histologic" value="Secretory carcinoma " class=""> Secretory carcinoma
                </div>
				 <div class="form-group col-md-6">
                  <input type="radio" name="histologic" value="Invasive carcinoma, type cannot be determined" class=""> Invasive carcinoma, type cannot be determined
                </div>
				<div class="form-group col-md-6">
				   <input type="radio" name="histologic" value="Other histologic type not listed" class=""> Other histologic type not listed (specify)
                  <input type="text" name="histologic_explain" placeholder="Other histologic type not listed (specify): ____________________________  " class="form-control">
                </div>
				<br/>
				<p style="padding: 10px;" class="justify"><i>Note: Determination of histologic type is based on routine histologic examination; special stains such as e-cadherin are not required for determining histologic type. The histologic type corresponds to the largest carcinoma. If there are smaller carcinomas of a different type, this information should be included under “Additional Pathologic Findings.”
				<br/>Note: Special type carcinomas should consist of at least 90% pure pattern.</i></p>
	...
	<div class="row">
		<div class="col-md-12">
			<div class="heading-line-bottom">
			  <h4 class="heading-title">Histologic Grade (Nottingham Histologic Score) <a href="#" data-toggle="modal" data-target="#myModal6"><i class="fa fa-question-circle"></i></a><code>*</code></h4>
			 </div>
			 ...
			 <!-- Modal -->
			  ...
			  <div class="row">
                <div class="form-group col-md-6">
                  <input type="radio" name="histologic_grade" value="No residual invasive carcinoma " class="" notrequired> No residual invasive carcinoma
                </div>

                 <div class="form-group col-md-6">
                  <input type="radio" name="histologic_grade" value="Residual invasive carcinoma present" class=""> Residual invasive carcinoma	present
                </div>
				<br/>
			</div>

			<h4 class="heading-title">Glandular (Acinar)/Tubular Differentiation <code>*</code></h4>
			<hr>

		  <div class="row">
			<div class="form-group col-md-6">
			  <input type="radio" name="glandular" value="Score 1 (>75% of tumor area forming glandular/tubular structures)" class="" notrequired> Score 1 (>75% of tumor area forming glandular/tubular structures)
			</div>
			<div class="form-group col-md-6">
			  <input type="radio" name="glandular" value="Score 2 (10% to 75% of tumor area forming glandular/tubular structures)" class=""> Score 2 (10% to 75% of tumor area forming glandular/tubular structures)
			</div>
			 <div class="form-group col-md-6">
			  <input type="radio" name="glandular" value="Score 3 (<10% of tumor area forming glandular/tubular structures)" class=""> Score 3 (<10% of tumor area forming glandular/tubular structures)
			</div>
			 <div class="form-group col-md-6">
			  <input type="radio" name="glandular" value="Only microinvasion present (not graded)" class=""> Only microinvasion present (not graded)
			</div>
			<div class="form-group col-md-6">
			  <input type="radio" name="glandular" value="No residual invasive carcinoma" class=""> No residual invasive carcinoma
			</div>
			<div class="form-group col-md-6">
			  <input type="radio" name="glandular" value="Score cannot be determined" class=""> Score cannot be determined
			</div>
		  </div>

		  <h4 class="heading-title">Nuclear Pleomorphism <code>*</code></h4>
			<hr>

		  <div class="row">
			<div class="form-group col-md-6">
			  <input type="radio" name="nuclear_pleomorphism" value="Score 1 (nuclei small with little increase in size in comparison with normal breast epithelial cells, regular outlines, uniform nuclear chromatin, little variation in size)" class=""> Score 1 (nuclei small with little increase in size in comparison with normal breast epithelial cells, regular outlines, uniform nuclear chromatin, little variation in size)
			</div>
			<div class="form-group col-md-6">
			  <input type="radio" name="nuclear_pleomorphism" value="Score 2 (cells larger than normal with open vesicular nuclei, visible nucleoli, and moderate variability in both size and shape)" class=""> Score 2 (cells larger than normal with open vesicular nuclei, visible nucleoli, and moderate variability in both size and shape)
			</div>
			 <div class="form-group col-md-6">
			  <input type="radio" name="nuclear_pleomorphism" value="Score 3 (vesicular nuclei, often with prominent nucleoli, exhibiting marked variation in size and shape, occasionally with very large and bizarre forms)" class=""> Score 3 (vesicular nuclei, often with prominent nucleoli, exhibiting marked variation in size and shape, occasionally with very large and bizarre forms)
			</div>
			 <div class="form-group col-md-6">
			  <input type="radio" name="nuclear_pleomorphism" value="Only microinvasion present (not graded)" class=""> Only microinvasion present (not graded)
			</div>
			<div class="form-group col-md-6">
			  <input type="radio" name="nuclear_pleomorphism" value="No residual invasive carcinoma" class=""> No residual invasive carcinoma
			</div>
			<div class="form-group col-md-6">
			  <input type="radio" name="nuclear_pleomorphism" value="Score cannot be determined" class="" notrequired> Score cannot be determined
			</div>
		  </div>


		  <h4 class="heading-title">Mitotic Rate <a href="#" data-toggle="modal" data-target="#myModal20">(see Table 1)</a><code>*</code></h4>
			<hr>
              ...
              <div class="modal fade" id="myModal20" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                <div class="modal-dialog modal-lg" role="document">
                  <div class="modal-content">
                    <div class="modal-header">
                      <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                      <h4 class="modal-title" id="myModalLabel"> Mitotic Rate (table 1)</h4>
                    </div>
                    <div class="modal-body">
                     <p><strong>Table 1. Score Categories According to Field Diameter and Mitotic Count</strong></p>
                        <table class="table table-striped table-dark">
                        <thead>
                        <tr>
                        <td colspan="5" width="666">
                        <p><strong>Scoring Categories of Mitotic Counts</strong></p>
                        </td>
                        </tr>
                        <tr>
                        <td rowspan="2" width="168">
                        <p><br /> Field diameter (mm)</p>
                        </td>
                        <td rowspan="2" width="144">
                        <p><br /> Area (mm<sup>2</sup>)</p>
                        </td>
                        <td colspan="3" width="354">
                        <p>Number of mitoses per 10 fields corresponding to:</p>
                        </td>
                        </tr>
                        <tr>
                        <td width="120">
		  ...
		  <div class="row">
			<div class="form-group col-md-6">
			  <input type="radio" name="mitotic_rate" value="Score 1" class="" notrequired> Score 1
			</div>
			<div class="form-group col-md-6">
			  <input type="radio" name="mitotic_rate" value="Score 2" class=""> Score 2
			</div>
			 <div class="form-group col-md-6">
			  <input type="radio" name="mitotic_rate" value="Score 3" class=""> Score 3
			</div>
			 <div class="form-group col-md-6">
			  <input type="radio" name="mitotic_rate" value="Only microinvasion present (not graded)" class=""> Only microinvasion present (not graded)
			</div>
			<div class="form-group col-md-6">
			  <input type="radio" name="mitotic_rate" value="No residual invasive carcinoma" class=""> No residual invasive carcinoma
			</div>
			<div class="form-group col-md-6">
			  <input type="radio" name="mitotic_rate" value="Score cannot be determined" class=""> Score cannot be determined
			</div>
		  </div>

		  <h4 class="heading-title">Overall Grade <code>*</code></h4>
			<hr>

		  <div class="row">
			<div class="form-group col-md-6">
			  <input type="radio" name="overall_grade" value="Grade 1 (scores of 3, 4, or 5) " class="" notrequired> Grade 1 (scores of 3, 4, or 5)
			</div>
			<div class="form-group col-md-6">
			  <input type="radio" name="overall_grade" value="Grade 2 (scores of 6 or 7) " class=""> Grade 2 (scores of 6 or 7)
			</div>
			 <div class="form-group col-md-6">
			  <input type="radio" name="overall_grade" value="Grade 3 (scores of 8 or 9) " class=""> Grade 3 (scores of 8 or 9)
			</div>
			 <div class="form-group col-md-6">
			  <input type="radio" name="overall_grade" value="Only microinvasion present (not graded)" class=""> Only microinvasion present (not graded)
			</div>
			<div class="form-group col-md-6">
			  <input type="radio" name="overall_grade" value="No residual invasive carcinoma" class=""> No residual invasive carcinoma
			</div>
			<div class="form-group col-md-6">
			  <input type="radio" name="overall_grade" value="Score cannot be determined" class=""> Score cannot be determined
			  <input type="text" name="overall_gradeexplain" Placeholder="Explain" class="form-control">
			</div>
		  </div>
		 <br/>
		 <p><i>Note: The grade corresponds to the largest area of invasion. If there are smaller foci of invasion of a different grade, this information should be included under “Additional Pathologic Findings.”</i></p>
	...
	<div class="row">
		<div class="col-md-12">
			<div class="heading-line-bottom">
			  <h4 class="heading-title">Tumor Focality <a href="#" data-toggle="modal" data-target="#myModal7"><i class="fa fa-question-circle"></i></a>
				 <br/> This section is optional
			  </h4>
			 </div>
			 ...
			 <!-- Modal -->
                ...
                <div class="modal-dialog modal-lg" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
					  ...
					  <p><img src="reporting_images/tumor_focality1.png" class="img-responsive" />
			  ...
			  <div class="row">
                <div class="form-group col-md-6">
                  <input type="radio" name="tumor_focality" value="Single focus of invasive carcinoma " class=""> Single focus of invasive carcinoma
                </div>
				 <div class="form-group col-md-6">
                  <input type="radio" name="tumor_focality" value="Cannot be determined " class=""> Cannot be determined
                </div>
				 <div class="form-group col-md-12">
                  <input type="radio" name="tumor_focality" value="Multiple foci of invasive carcinoma " class=""> Multiple foci of invasive carcinoma
					 <div style="padding-left: 40px;" class="row">
						<div class="form-group col-md-6">
						 <label>Tumor Focality Number</label>
						   <p><strong>Number of foci:</strong> <input type="text" style="width: 30%" name="foci_no" class="form-control"></p>
						   <p><strong>Number of foci is at least: </strong><input style="width: 30%" type="text" name="foci_atleast" class="form-control"></p>
						   <p><strong>Number of foci cannot be determined</strong> <input type="checkbox" name="foci_undetermined" value="Number of foci cannot be determined" class=""></p>
						   <p><strong>Sizes of individual foci (millimeters): ____mm </strong><input style="width: 30%" type="text" name="foci_size" class="form-control"></p>
						</div>
					</div>
                </div>
				</div>
				<br/>
				<p><i>Note: If there are multiple invasive carcinomas, size, grade, histologic type, and the results of studies for estrogen receptor (ER), progesterone receptor (PgR), and HER2 should pertain to the largest invasive carcinoma. If smaller invasive carcinomas differ in any of these features, this information may be included in the “Comments” section</i></p>
		</div>
	</div>
	...
	<div class="row">
		<div class="col-md-12">
			<div class="heading-line-bottom">
			  <h4 class="heading-title">Ductal Carcinoma In Situ (DCIS) <a href="#" data-toggle="modal" data-target="#myModal8"><i class="fa fa-question-circle"></i></a>
				 <br/> This section is optional
			  </h4>
			 </div>
			 ...
			 <!-- Modal -->
                ...
                <div class="modal-dialog modal-lg" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
					  ...
					  <p><img src="reporting_images/situ1.png" class="img-responsive" />
			  ...
			  <div class="row">
                <div class="form-group col-md-6">
                  <input type="radio" name="dcis" value="Not identified " class=""> Not identified
                </div>
				 <div class="form-group col-md-12">
                  <input type="radio" name="dcis" value="Present" class=""> Present
					 <div style="padding-left: 40px;" class="row">
						<div class="form-group col-md-6">
						 <input type="radio" name="dcis_present" value="Negative for extensive intraductal component (EIC) " class=""> Negative for extensive intraductal component (EIC)
						</div>
						<div class="form-group col-md-6">
						 <input type="radio" name="dcis_present" value="Positive for extensive intraductal component (EIC)" class=""> Positive for extensive intraductal component (EIC)
						</div>
						<div class="form-group col-md-12">
						 <input type="radio" name="dcis_present" value="Only DCIS is present after presurgical (neoadjuvant) therapy" class=""> Only DCIS is present after presurgical (neoadjuvant) therapy
						</div>
						<br/><br/>
						<p><i>Note: If there has been prior neoadjuvant treatment and only residual DCIS, the cancer is classified as ypTis.</i></p>
					</div>
                </div>
				<div class="form-group col-md-6">
                  <input type="radio" name="dcis" value="Cannot be excluded " class=""> Cannot be excluded
                </div>
			</div>
			<br/>
			 <h4 class="heading-title">Size (Extent) of DCIS (Select all that apply) <br/> This section is optional</h4>
			<hr>

		  <div class="row">
			<div class="form-group col-md-12">
			 <label>Estimated size (extent) of DCIS is at least (millimeters)</label>
			  <input type="text" name="dcis_size" placeholder="Estimated size (extent) of DCIS is at least (millimeters) " class="form-control">
			  <div style="padding-left: 40px;" class="row">
					<div class="form-group col-md-6">
					  <label>Additional dimensions (All measurements are in mm)</label>
						<div class="row">
							<div class="form-group col-md-5">
							  <input type="text" style="width: 30%" name="dcis_size_length" class="form-control">
							</div>
							<div class="form-group col-md-2">
							  <p style="padding: 10px;" class="text-center"> X </p>
							</div>
							<div class="form-group col-md-5">
							  <input type="text" style="width: 30%" name="dcis_size_width" class="form-control">
							</div>
						 </div>
					</div>
			  </div>
			...
			<div class="form-group col-md-6">
			  ...
			  <input type="text" style="width: 30%" name="dcis_block" placeholder="Number of blocks with DCIS: " class="form-control">
			</div>
			<div class="form-group col-md-6">
			  <label>Number of blocks examined</label>
			  <input type="text" style="width: 30%" name="dcis_block_examined" placeholder="Number of blocks examined " class="form-control">
			</div>
		  </div>

		  <br/><br/>
		  <p><i>Note: The size (extent) of DCIS (greatest dimension using gross and microscopic evaluation) is an estimation of the volume of breast tissue occupied by DCIS. This information may be helpful for cases with a predominant component of DCIS (eg, DCIS with microinvasion) but may not be necessary for cases of EIC-negative invasive carcinomas.</i></p>

		 <br/>
			 <h4 class="heading-title">Architectural Patterns (if DCIS is present in specimen select all that apply)</h4>
			<hr>

		  <div class="row">
			<div class="form-group col-md-6">
			  <input type="checkbox" name="dcis_ap_comedo" value="Comedo" class=""> Comedo
			</div>
			<div class="form-group col-md-6">
			  <input type="checkbox" name="dcis_ap_pd" value="Paget disease (DCIS involving nipple skin)" class=""> Paget disease (DCIS involving nipple skin)
			</div>
			<div class="form-group col-md-6">
			  <input type="checkbox" name="dcis_ap_cribriform" value="Cribriform" class=""> Cribriform
			</div>
			<div class="form-group col-md-6">
			  <input type="checkbox" name="dcis_ap_micropapillary" value="Micropapillary" class=""> Micropapillary
			</div>
			<div class="form-group col-md-6">
			  <input type="checkbox" name="dcis_ap_papillary" value="Papillary" class=""> Papillary
			</div>
			<div class="form-group col-md-6">
			  <input type="checkbox" name="dcis_ap_solid" value="Solid" class=""> Solid
			</div>
			<div class="form-group col-md-12">
			   <input type="checkbox" name="dcis_ap_other" value="Other(specify):" class=""> Other(Specify)
			  <input type="text" name="dcis_ap_otherspecify" placeholder="Other(specify) " class="form-control">
			</div>
		  </div>


		  <br/>
			 <h4 class="heading-title"> Nuclear Grade (if DCIS is present in specimen, see Table 2)</h4>
			<hr>

		  <div class="row">
			<div class="form-group col-md-6">
			  <input type="radio" name="dcis_nuclear_grade" value="Grade I (low)" class=""> Grade I (low)
			</div>
			<div class="form-group col-md-6">
			  <input type="radio" name="dcis_nuclear_grade" value="Grade II (Intermediate)" class=""> Grade II (Intermediate)
			</div>
			<div class="form-group col-md-6">
			  <input type="radio" name="dcis_nuclear_grade" value="Grade III (High)" class=""> Grade III (High)
			</div>
		  </div>

		   <br/>
			 <h4 class="heading-title"> Necrosis (If DCIS is present in specimen)</h4>
			<hr>

		  <div class="row">
			<div class="form-group col-md-6">
			  <input type="radio" name="dcis_necrosis" value="Not identified" class=""> Not identified
			</div>
			<div class="form-group col-md-6">
			  <input type="radio" name="dcis_necrosis" value="Present, focal (small foci or single cell necrosis)" class=""> Present, focal (small foci or single cell necrosis)
			</div>
			<div class="form-group col-md-6">
			  <input type="radio" name="dcis_necrosis" value="Present, central (expansive “comedo” necrosis)" class=""> Present, central (expansive “comedo” necrosis)
			</div>
		  </div>

		   <br/>
			 <h4 class="heading-title"> Lobular Carcinoma In Situ (LCIS)</h4>
			<hr>

		  <div class="row">
			<div class="form-group col-md-6">
			  <input type="radio" name="lcis" value="Not identified" class=""> No LCIS in specimen
			</div>
			<div class="form-group col-md-6">
			  <input type="radio" name="lcis" value="Present" class=""> Present
			</div>
		  </div>
	...
	<div class="row">
		<div class="col-md-12">
			<div class="heading-line-bottom">
			  <h4 class="heading-title">Tumor Extension (required only if the structures are present and involved) <a href="#" data-toggle="modal" data-target="#myModal9"><i class="fa fa-question-circle"></i></a></h4>
			 </div>
			 <h4 class="heading-title">Skin</h4>
			 ...
			 <!-- Modal -->
			  ...
			  <div class="row">
                <div class="form-group col-md-6">
                  <input type="radio" name="tumor_extension_skin" value="Skin is not present " class=""> Skin is not present
                </div>
				 <div class="form-group col-md-6">
                  <input type="radio" name="tumor_extension_skin" value="Skin is present and uninvolved " class=""> Skin is present and uninvolved
                </div>
				<div class="form-group col-md-6">
                  <input type="radio" name="tumor_extension_skin" value="Invasive carcinoma directly invades into the dermis or epidermis without skin ulceration (this does not change the T stage) " class=""> Invasive carcinoma directly invades into the dermis or epidermis without skin ulceration (this does not change the T stage)
                </div>
				 <div class="form-group col-md-6">
                  <input type="radio" name="tumor_extension_skin" value="Invasive carcinoma directly invades into the dermis or epidermis with skin ulceration (classified as T4b) " class=""> Invasive carcinoma directly invades into the dermis or epidermis with skin ulceration (classified as T4b)
                </div>
				<div class="form-group col-md-6">
                  <input type="radio" name="tumor_extension_skin" value="Satellite skin foci of invasive carcinoma are present (ie, not contiguous with the invasive carcinoma in the breast) (classified as T4b) " class=""> Satellite skin foci of invasive carcinoma are present (ie, not contiguous with the invasive carcinoma in the breast) (classified as T4b)
                </div>

				</div>
				 <br/>
				<p><i>Note: Satellite skin nodules must be separate from the primary tumor and macroscopically identified to assign a category as T4b. Skin nodules identified only on microscopic examination and in the absence of epidermal ulceration or skin edema (clinical peau d’orange) do not qualify as T4b. Such tumors should be categorized based on tumor size</i></p>

			<br/>
			 <h4 class="heading-title"> Nipple</h4>
			<hr>

		  <div class="row">
			<div class="form-group col-md-6">
			  <input type="radio" name="tumor_extension_nipple" value="DCIS does not involve the nipple epidermis " class=""> DCIS does not involve the nipple epidermis
			</div>
			<div class="form-group col-md-6">
			  <input type="radio" name="tumor_extension_nipple" value="DCIS involves nipple epidermis (Paget disease of the nipple)" class=""> DCIS involves nipple epidermis (Paget disease of the nipple)
			</div>
		  </div>
		  <br/>
		  <p><i>Note: This finding does not change the T classification of invasive carcinomas</i></p>

		  <br/>
			 <h4 class="heading-title"> Skeletal Muscle</h4>
			<hr>

		  <div class="row">
			<div class="form-group col-md-6">
			  <input type="radio" name="tumor_extension_sm" value="No skeletal muscle is present " class=""> No skeletal muscle is present
			</div>
			<div class="form-group col-md-6">
			  <input type="radio" name="tumor_extension_sm" value="Skeletal muscle is free of carcinoma" class=""> Skeletal muscle is free of carcinoma
			</div>
			<div class="form-group col-md-6">
			  <input type="radio" name="tumor_extension_sm" value="Carcinoma invades skeletal muscle " class=""> Carcinoma invades skeletal muscle
			</div>
			<div class="form-group col-md-6">
			  <input type="radio" name="tumor_extension_sm" value="Carcinoma invades into skeletal muscle and into the chest wall (classified as T4a)" class=""> Carcinoma invades into skeletal muscle and into the chest wall (classified as T4a)
			</div>
		  </div>
		  <br/>
		  <p><i>Note: Invasion into pectoralis muscle is not considered chest wall invasion, and cancers are not classified as T4a unless there is invasion deeper than this muscle.</i></p>
			  ...
			  <div class="row">
				...
				<div class="form-group col-md-12">
                  <input type="radio" name="icm" value="Uninvolved by invasive carcinoma" class=""> Uninvolved by invasive carcinoma
					 <div style="padding-left: 40px;" class="row">
						<div class="form-group col-md-6">
						 <label>Distance from closest margin (millimeters):</label>
						   <p><strong>Specify ___ mm  </strong><br/><input style="width: 30%" type="text" name="icm_distance_specify" placeholder="Specify ___ mm " class="form-control"></p>
						   <p><strong>Less than ____ mm </strong><br/><input style="width: 30%" type="text" name="icm_distance_less_than" placeholder="Less than ____ mm " class="form-control"></p>
						   <p><strong>Greater than ___ mm   </strong><br/> <input style="width: 30%" type="text" name="icm_distance_greaterthan" placeholder="Greater than ___ mm  " class="form-control"></p>
						</div>
						<div class="form-group col-md-12">
						  <input type="radio" name="icm_distance" value="Cannot be determined:" class=""> Cannot be determined (explain):
							<input type="text" name="icm_distance_explain" placeholder="Explain Please  " class="form-control">
						</div>

						<div class="form-group col-md-12">
						 <label>Specify closest margin (required only if <10mm):</label>
						   <input type="text" style="width: 30%" name="icm_margins" placeholder="Specify closest margin (required only if <10mm) " class="form-control">
						</div>
						<div class="form-group col-md-12">
						  <input type="radio" name="icm_margins" value="Cannot be determined" class=""> Cannot be determined (explain):
							<input type="text" name="icm_margins_explain" placeholder="Explain Please  " class="form-control">
						</div>
						<div class="form-group col-md-12">
						 <label>Distance from other margins (specify millimeter distance including greater than if appropriate): </label>
						   <p>Anterior </p><input type="text" style="width: 30%" name="icm_margins_distance_anterior" placeholder="Anterior" class="form-control">
						   <p>Posterior </p><input type="text" style="width: 30%" name="icm_margins_distance_posterior" placeholder="Posterior" class="form-control">
						    <p>Superior </p><input type="text" style="width: 30%" name="icm_margins_distance_superior" placeholder="Superior" class="form-control">
						    <p>Inferior </p><input type="text" style="width: 30%" name="icm_margins_distance_inferior" placeholder="Inferior" class="form-control">
						    <p>Medial </p><input type="text" style="width: 30%" name="icm_margins_distance_medial" placeholder="Medial" class="form-control">
						    <p>Lateral </p><input type="text" style="width: 30%" name="icm_margins_distance_lateral" placeholder="Lateral" class="form-control">
						    <p>Others </p><input type="text" name="icm_margins_distance_others" placeholder="Others(Specify)" class="form-control">

						</div>
					</div>
                </div>
				<div class="form-group col-md-12">
                  <input type="radio" name="icm" value="Positive for invasive carcinoma " class=""> Positive for invasive carcinoma (select all that apply):
					 <div style="padding-left: 40px;" class="row">
						<div class="form-group col-md-6">
						   <input type="checkbox" name="pic_anterior" value="Anterior " class=""> Anterior
							<p style="padding-left: 60px;">Extent <br/><input style="width: 30%" type="text" name="pic_anterior_ex" placeholder="Anterior Extent" class="form-control"></p>
						</div>
						<div class="form-group col-md-6">
						   <input type="checkbox" name="pic_posterior" value="Posterior " class=""> Posterior
							<p style="padding-left: 60px;">Extent <br/><input style="width: 30%" type="text" name="pic_posterior_ex" placeholder="Posterior Extent" class="form-control"></p>
						</div>
						<div class="form-group col-md-6">
						   <input type="checkbox" name="pic_superior" value="Superior " class=""> Superior
							<p style="padding-left: 60px;">Extent <br/><input style="width: 30%" type="text" name="pic_superior_ex" placeholder="Superior Extent" class="form-control"></p>
						</div>
						<div class="form-group col-md-6">
						   <input type="checkbox" name="pic_inferior" value="Inferior " class=""> Inferior
							<p style="padding-left: 60px;">Extent <br/><input style="width: 30%" type="text" name="pic_inferior_ex" placeholder="Inferior Extent" class="form-control"></p>
						</div>
						<div class="form-group col-md-6">
						   <input type="checkbox" name="pic_medial" value="Medial " class=""> Medial
							<p style="padding-left: 60px;">Extent <br/><input style="width: 30%" type="text" name="pic_medial_ex" placeholder="Medial Extent" class="form-control"></p>
						</div>
						<div class="form-group col-md-6">
						   <input type="checkbox" name="pic_lateral" value="Lateral " class=""> Lateral
							<p style="padding-left: 60px;">Extent <br/><input style="width: 30%" type="text" name="pic_lateral_ex" placeholder="Lateral Extent" class="form-control"></p>
						</div>
						<div class="form-group col-md-6">
						   <input type="checkbox" name="pic_others" value="Others " class=""> Others(Specify)
							<p style="padding-left: 60px;">Extent <br/><input type="text" name="pic_others_ex" placeholder="Others Extent" class="form-control"></p>
						</div>
						<div class="form-group col-md-6">
						   <input type="checkbox" name="pic_undertermined" value="Lateral " class=""> Cannot be determined
							<p style="padding-left: 60px;">Explain <br/><input type="text" name="pic_undetermined_explain" placeholder="Lateral Extent" class="form-control"></p>
						</div>
					  </div>
                </div>
				</div>
				<br/>
				<p><i>Note: Margin status is listed as “positive” if there is ink on invasive carcinoma (ie, the distance is 0 mm). If the margin is not positive, then a distance from the margin may be listed. Distances can be specific measurements or expressed as greater than or less than a measurement. Extent may be specified as unifocal, multifocal, or extensive</i></p>

				<h4 class="heading-title">DCIS Margins (required only if DCIS is present in specimen)</h4>
			  <hr>
			  <div class="row">
			    <div class="form-group col-md-6">
                  <input type="radio" name="dcism" value="Not applicable (no DCIS in specimen)" class=""> Not applicable (no DCIS in specimen)
                </div>
                <div class="form-group col-md-6">
                  <input type="radio" name="dcism" value="Cannot be assessed  " class=""> Cannot be assessed
                </div>
				<div class="form-group col-md-12">
                  <input type="radio" name="dcism" value="Uninvolved by DCIS" class=""> Uninvolved by DCIS
                </div>
				 <div style="padding-left: 40px;" class="row">
						<div class="form-group col-md-6">
						 <label>Distance from closest margin (millimeters):</label>
						   <p><strong>Specify ___ mm  </strong><br/><input style="width: 30%" type="text" name="dcism_distance_specify" placeholder="Specify ___ mm " class="form-control"></p>
						   <p><strong>Less than ____ mm </strong><br/><input style="width: 30%" type="text" name="dcism_distance_less_than" placeholder="Less than ____ mm " class="form-control"></p>
						   <p><strong>Greater than ___ mm   </strong><br/><input style="width: 30%" type="text" name="dcism_distance_greaterthan" placeholder="Greater than ___ mm  " class="form-control"></p>
						</div>
						<div class="form-group col-md-12">
						  <input type="radio" name="dcism_distance" value="Cannot be determined" class=""> Cannot be determined (explain):
							<input type="text" name="dcism_distance_explain" placeholder="Explain Please  " class="form-control">
						</div>

						<div class="form-group col-md-12">
						 <label>Specify closest margin (required only if <10mm):</label>
						   <input type="text" style="width: 30%" name="dcism_margins" placeholder="Specify closest margin (required only if <10mm) " class="form-control">
						</div>
						<div class="form-group col-md-12">
						  <input type="radio" name="dcism_margins" value="Cannot be determined" class=""> Cannot be determined (explain):
							<input type="text" name="dcism_margins_explain" placeholder="Explain Please  " class="form-control">
						</div>
						<div class="form-group col-md-12">
						 <label>Distance from other margins (specify millimeter distance including greater than if appropriate): </label>
						   <p>Anterior </p><input type="text" style="width: 30%" name="dcism_margins_distance_anterior" placeholder="Anterior" class="form-control">
						   <p>Posterior </p><input type="text" style="width: 30%" name="dcism_margins_distance_posterior" placeholder="Posterior" class="form-control">
						    <p>Superior </p><input type="text" style="width: 30%" name="dcism_margins_distance_superior" placeholder="Superior" class="form-control">
						    <p>Inferior </p><input type="text" style="width: 30%" name="dcism_margins_distance_inferior" placeholder="Inferior" class="form-control">
						    <p>Medial </p><input type="text" style="width: 30%" name="dcism_margins_distance_medial" placeholder="Medial" class="form-control">
						    <p>Lateral </p><input type="text" style="width: 30%" name="dcism_margins_distance_lateral" placeholder="Lateral" class="form-control">
						    <p>Others(Specify) </p><input type="text" name="dcism_margins_distance_others" placeholder="Others(Specify)" class="form-control">

						</div>
					</div>
				<div class="form-group col-md-12">
                  <input type="radio" name="dcism" value="Positive for invasive carcinoma " class=""> Positive for DCIS (select all that apply):
					 <div style="padding-left: 40px;" class="row">
						<div class="form-group col-md-6">
						   <input type="checkbox" name="pdcis_anterior" value="Anterior " class=""> Anterior
							<p style="padding-left: 60px;">Extent <br/><input style="width: 30%" type="text" name="pdcis_anterior_ex" placeholder="Anterior Extent" class="form-control"></p>
						</div>
						<div class="form-group col-md-6">
						   <input type="checkbox" name="pdcis_posterior" value="Posterior " class=""> Posterior
							<p style="padding-left: 60px;">Extent <br/><input style="width: 30%" type="text" name="pdcis_posterior_ex" placeholder="Posterior Extent" class="form-control"></p>
						</div>
						<div class="form-group col-md-6">
						   <input type="checkbox" name="pdcis_superior" value="Superior " class=""> Superior
							<p style="padding-left: 60px;">Extent <br/><input style="width: 30%" type="text" name="pdcis_superior_ex" placeholder="Superior Extent" class="form-control"></p>
						</div>
						<div class="form-group col-md-6">
						   <input type="checkbox" name="pdcis_inferior" value="Inferior " class=""> Inferior
							<p style="padding-left: 60px;">Extent <br/><input style="width: 30%" type="text" name="pdcis_inferior_ex" placeholder="Inferior Extent" class="form-control"></p>
						</div>
						<div class="form-group col-md-6">
						   <input type="checkbox" name="pdcis_medial" value="Medial " class=""> Medial
							<p style="padding-left: 60px;">Extent <br/><input style="width: 30%" type="text" name="pdcis_medial_ex" placeholder="Medial Extent" class="form-control"></p>
						</div>
						<div class="form-group col-md-6">
						   <input type="checkbox" name="pdcis_lateral" value="Lateral " class=""> Lateral
							<p style="padding-left: 60px;">Extent <br/><input style="width: 30%" type="text" name="pdcis_lateral_ex" placeholder="Lateral Extent" class="form-control"></p>
						</div>
						<div class="form-group col-md-6">
						   <input type="checkbox" name="pdcis_others" value="Others " class=""> Others(Specify)
							<p style="padding-left: 60px;">Extent <br/><input type="text" name="pdcis_others_ex" placeholder="Others Extent" class="form-control"></p>
						</div>
						<div class="form-group col-md-6">
						   <input type="checkbox" name="pdcis_undertermined" value="Cannot be determined " class=""> Cannot be determined
							<p style="padding-left: 60px;">Explain <br/><input type="text" name="pdcis_undetermined_explain" placeholder="Lateral Extent" class="form-control"></p>
						</div>
					  </div>
                </div>
				</div>
		...
		<div class="col-md-12">
			<div class="heading-line-bottom">
			 ...
			 <!-- Modal -->
			  ...
			  <div class="row">
                <div class="form-group col-md-6">
                  <input type="radio" name="rln" value="No lymph nodes submitted or found " class="" notrequired> No lymph nodes submitted or found
                </div>
				<div class="form-group col-md-12">
                  <input type="radio" name="rln" value="Uninvolved by tumor cells" class=""> Uninvolved by tumor cells
					 <div style="padding-left: 40px;" class="row">
						<div class="form-group col-md-6">
						 <label>Number of Lymph Nodes Examined:</label>
						   <input type="text" style="width: 30%" name="rln_uninvolved_ln" placeholder="Number of Lymph Nodes Examined: " class="form-control">
						</div>
						<div class="form-group col-md-6">
						 <label>Number of Sentinel Nodes Examined (if applicable):</label>
						   <input type="text" style="width: 30%" name="rln_uninvolved_sn" placeholder="Number of Sentinel Nodes Examined (if applicable): " class="form-control">
						</div>
					</div>
                </div>
				<div class="form-group col-md-12">
                  <input type="radio" name="rln" value="Involved by tumor cells" class=""> Involved by tumor cells
					 <div style="padding-left: 40px;" class="row">
						<div class="form-group col-md-12">
						 <label>Number of Lymph Nodes with Macrometastases (>2 mm): </label>
						   <input type="text" style="width: 30%" name="rln_involved_ln_mac" placeholder="Number of Lymph Nodes with Macrometastases (>2 mm): " class="form-control">
						</div>
						<div class="form-group col-md-12">
						 <label>Number of Lymph Nodes with Micrometastases (>0.2 mm to 2 mm and/or >200 cells): </label>
						   <input type="text" style="width: 30%" name="rln_involved_ln_mic" placeholder="Number of Lymph Nodes with Micrometastases (>0.2 mm to 2 mm and/or >200 cells): " class="form-control">
						</div>
						<div class="form-group col-md-12">
						 <label>Number of Lymph Nodes with Isolated Tumor Cells (≤0.2 mm or ≤200 cells): </label>
						   <input type="text" style="width: 30%" name="rln_involved_ln_itc" placeholder="Number of Lymph Nodes with Isolated Tumor Cells (≤0.2 mm or ≤200 cells): " class="form-control">
						</div>
					</div>
                </div>

				<br/>
				<p style="padding-left: 10px;"><i>Reporting the number of lymph nodes with isolated tumor cells is required only in the absence of macrometastasis or micrometastasis in other lymph nodes.</i></p>

				<div class="form-group col-md-12">

				 <label>Size of Largest Metastatic Deposit (millimeters):</label>
                  <input type="text" style="width: 30%" name="rln_deposit" placeholder="Size of Largest Metastatic Deposit (millimeters): " class="form-control">
                </div>


				<br/>
				 <h4  style="padding-left: 10px;"class="heading-title"> Extranodal Extension <code>*</code></h4>
				<hr style="padding-left: 10px;">

			  <div style="padding-left: 10px;" class="row">
				<div class="form-group col-md-6">
				  <input type="radio" name="extranodal_ext" value="Not identified " class="" notrequired> Not identified
				</div>
				<div class="form-group col-md-6">
				  <input type="radio" name="extranodal_ext" value="Present" class=""> Present
				</div>
				<div class="form-group col-md-6">
				  <input type="radio" name="extranodal_ext" value="Cannot be determined" class=""> Cannot be determined
				</div>
			  </div>

			  <div class="form-group col-md-6">
				 <label>Number of Lymph Nodes Examined: </label>
                  <input type="text" style="width: 30%" name="ln_examined" placeholder="Number of Lymph Nodes Examined" class="form-control" notrequired>
                </div>

				<div class="form-group col-md-6">
				 <label>Number of Sentinel Nodes Examined (if applicable):</label>
                  <input type="text" style="width: 30%" name="sn_examined" placeholder="Number of Sentinel Nodes Examined (if applicable): " class="form-control" notrequired>
                </div>
			  </div>
		</div>
	</div>
	...
	<div class="row">
		<div class="col-md-12">
			<div class="heading-line-bottom">
			  <h4 class="heading-title">Treatment Effect (required only if known) <a href="#" data-toggle="modal" data-target="#myModal12"><i class="fa fa-question-circle"></i></a></h4>
			 </div>
			 ...
			 <!-- Modal -->
			  ...
			  <p> This section is optional </p>
			   <div class="row">
                <div class="form-group col-md-6">
                  <input type="radio" name="presurgical_therapy" value="No known presurgical therapy" class=""> No known presurgical therapy
                </div>
				<div class="form-group col-md-6">
                  <input type="radio" name="presurgical_therapy" value="Known presurgical therapy" class="">  Known presurgical therapy
                </div>
			   </div>

				<p><i>The following questions about treatment effect are required only if it is known that the patient had presurgical therapy. </i></p>

			  	<br/>
				 <h4 class="heading-title"> Treatment Effect in the Breast</h4>
				<hr>

				  <div class="row">
					<div class="form-group col-md-6">
					  <input type="radio" name="breast_treatment_effect" value="No definite response to presurgical therapy in the invasive carcinoma " class=""> No definite response to presurgical therapy in the invasive carcinoma
					</div>
					<div class="form-group col-md-6">
					  <input type="radio" name="breast_treatment_effect" value="Probable or definite response to presurgical therapy in the invasive carcinoma" class=""> Probable or definite response to presurgical therapy in the invasive carcinoma
					</div>
					<div class="form-group col-md-6">
					  <input type="radio" name="breast_treatment_effect" value="No residual invasive carcinoma is present in the breast after presurgical therapy " class=""> No residual invasive carcinoma is present in the breast after presurgical therapy
					</div>
				  </div>

				 <p><i>Note: The largest focus of residual tumor, if present, is used to determine ypT category. Treatment-related fibrosis in the tumor bed adjacent to residual invasive carcinoma is not included in determining ypT </i></p>

				<br/>
				 <h4 class="heading-title"> Treatment Effect in the Lymph Nodes</h4>
				<hr>

				  <div class="row">
					<div class="form-group col-md-6">
					  <input type="radio" name="c" value="No lymph nodes removed " class=""> No lymph nodes removed
					</div>
					<div class="form-group col-md-6">
					  <input type="radio" name="ln_treatment_effect" value="No definite response to presurgical therapy in metastatic carcinoma" class=""> No definite response to presurgical therapy in metastatic carcinoma
					</div>
					<div class="form-group col-md-6">
					  <input type="radio" name="ln_treatment_effect" value="Probable or definite response to presurgical therapy in metastatic carcinoma " class=""> Probable or definite response to presurgical therapy in metastatic carcinoma
					</div>
					<div class="form-group col-md-6">
					  <input type="radio" name="ln_treatment_effect" value="No lymph node metastases. Fibrous scarring, possibly related to prior lymph node metastases with pathologic complete response " class=""> No lymph node metastases. Fibrous scarring, possibly related to prior lymph node metastases with pathologic complete response
					</div>
					<div class="form-group col-md-6">
					  <input type="radio" name="ln_treatment_effect" value="No lymph node metastases and no prominent fibrous scarring in the nodes " class=""> No lymph node metastases and no prominent fibrous scarring in the nodes
					</div>
				  </div>

				 <p><i>Note: The largest focus of residual tumor in the lymph nodes, if present, is used to determine ypN category. Treatment-related fibrosis adjacent to residual nodal deposits is not included in determining ypN dimension.</i></p>
		</div>
	</div>
	...
	<div class="row">
		<div class="col-md-12">
			<div class="heading-line-bottom">
			  <h4 class="heading-title">Lymphovascular Invasion <a href="#" data-toggle="modal" data-target="#myModal13"><i class="fa fa-question-circle"></i></a>
				<br/> This is optional
			  </h4>
			 </div>
			 ...
			 <!-- Modal -->
              <div class="modal fade" id="myModal13" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
			   ...
			   <br/>
				 <h4 class="heading-title"> Dermal Lymphovascular Invasion</h4>
				<hr>

				  <div class="row">
					<div class="form-group col-md-6">
					  <input type="radio" name="dermal_lymphovascular_invasion" value="No skin present " class=""> No skin present
					</div>
					<div class="form-group col-md-6">
					  <input type="radio" name="dermal_lymphovascular_invasion" value="Not identified" class=""> Not identified
					</div>
					<div class="form-group col-md-6">
					  <input type="radio" name="dermal_lymphovascular_invasion" value="Present " class=""> Present
					</div>
					<div class="form-group col-md-6">
					  <input type="radio" name="dermal_lymphovascular_invasion" value="Cannot be determined " class=""> Cannot be determined
					</div>
					<div class="form-group col-md-6">
					  <input type="radio" name="dermal_lymphovascular_invasion" value="No lymph node metastases and no prominent fibrous scarring in the nodes " class=""> No lymph node metastases and no prominent fibrous scarring in the nodes
					</div>
				  </div>
		</div>
	</div>
			   ...
			   <br/>
				...
				<hr>
				  ...
				  <div class="row">
					...
					<div class="form-group col-md-6">
					  <input type="radio" name="primary_tumor" value="pTis (DCIS):	Ductal carcinoma in situ#" class=""> pTis (DCIS):	Ductal carcinoma in situ#
					</div>
					<div class="form-group col-md-6">
					  <input type="radio" name="primary_tumor" value="pTis (Paget):	Paget disease of the nipple not associated with invasive carcinoma and/or DCIS in the underlying breast parenchyma##" class=""> pTis (Paget):	Paget disease of the nipple not associated with invasive carcinoma and/or DCIS in the underlying breast parenchyma##
					</div>
					<div class="form-group col-md-6">
					  <input type="radio" name="primary_tumor" value="pT1mi: Tumor ≤1 mm in greatest dimension" class=""> pT1mi: 	Tumor ≤1 mm in greatest dimension
					</div>
					<div class="form-group col-md-6">
					  <input type="radio" name="primary_tumor" value="pT1a:	Tumor >1 mm but ≤5 mm in greatest dimension (round any measurement >1.0−1.9 mm to 2 mm)" class=""> pT1a:	Tumor >1 mm but ≤5 mm in greatest dimension (round any measurement >1.0−1.9 mm to 2 mm)
					</div>
					<div class="form-group col-md-6">
					  <input type="radio" name="primary_tumor" value="pT1b:	Tumor >5 mm but ≤10 mm in greatest dimension" class=""> pT1b:	Tumor >5 mm but ≤10 mm in greatest dimension
					</div>
					<div class="form-group col-md-6">
					  <input type="radio" name="primary_tumor" value="pT1c:	Tumor >10 mm but ≤20 mm in greatest dimension" class=""> pT1c:	Tumor >10 mm but ≤20 mm in greatest dimension
					</div>
					<div class="form-group col-md-6">
					  <input type="radio" name="primary_tumor" value="pT2:	Tumor >20 mm but ≤50 mm in greatest dimension" class=""> pT2:	Tumor >20 mm but ≤50 mm in greatest dimension
					</div>
					<div class="form-group col-md-6">
					  <input type="radio" name="primary_tumor" value="pT3:	Tumor >50 mm in greatest dimension" class=""> pT3:	Tumor >50 mm in greatest dimension
					</div>
					<div class="form-group col-md-12">
					  <input type="radio" name="primary_tumor" value="pT4:  Tumor of any size with direct extension to the chest wall and/or to the skin (ulceration or skin nodules) ###" class=""> pT4:  Tumor of any size with direct extension to the chest wall and/or to the skin (ulceration or skin nodules) ###
					</div>
					<div class="form-group col-md-12">
					  <input type="radio" name="primary_tumor" value="pT4a:	Extension to the chest wall; invasion or adherence to pectoralis muscle in the absence of invasion of chest wall structures does not qualify as T4" class=""> pT4a:	Extension to the chest wall; invasion or adherence to pectoralis muscle in the absence of invasion of chest wall structures does not qualify as T4
					</div>
					<div class="form-group col-md-12">
					  <input type="radio" name="primary_tumor" value="pT4b:	Ulceration and/or ipsilateral macroscopic satellite nodules and/or edema (including peau d’orange) of the skin that does not meet the criteria for inflammatory carcinoma" class=""> pT4b:	Ulceration and/or ipsilateral macroscopic satellite nodules and/or edema (including peau d’orange) of the skin that does not meet the criteria for inflammatory carcinoma
					</div>
					<div class="form-group col-md-12">
					  <input type="radio" name="primary_tumor" value="pT4c:	Both T4a and T4b are present" class=""> pT4c:	Both T4a and T4b are present
					</div>
					<div class="form-group col-md-6">
					  <input type="radio" name="primary_tumor" value="pT4d:	Inflammatory carcinoma####" class=""> pT4d:	Inflammatory carcinoma
					</div>
				  </div>

				  <p><i># For the purposes of this case summary, these categories should only be used in the setting of preoperative (neoadjuvant) therapy for which a previously diagnosed invasive carcinoma is no longer present after treatment. Patients with pathological complete response (absence of residual invasive carcinoma in both the breast and lymph nodes) should be categorized as ypT0N0 or ypTisN0, not ypTX <br/><br/> ## Carcinomas in the breast parenchyma associated with Paget disease are categorized based on the size and characteristics of the parenchymal disease, although the presence of Paget disease should still be noted. <br/><br/>### Note: Invasion of the dermis alone does not qualify as pT4. <br/><br/> #### Inflammatory carcinoma requires the presence of clinical findings of erythema and edema involving at least one-third or more of the skin of the breast </i></p>

				<br/>
				 <h4 class="heading-title"> Regional Lymph Nodes (pN) (choose a category based on lymph nodes received with the specimen; immunohistochemistry and/or molecular studies are not required</h4>
				<hr>
				<p><i>Regional Lymph Nodes (pN) (choose a category based on lymph nodes received with the specimen; immunohistochemistry and/or molecular studies are not required</i></p>

				<br/>
				 <h4 class="heading-title"> Modifier (required only if applicable)</h4>
				<hr>

				<div class="row">
					<div class="form-group col-md-6">
					  <input type="radio" name="modifier" value="(sn):	Sentinel node(s) evaluated. If 6 or more nodes (sentinel or nonsentinel) are removed, this modifier should not be used." class=""  notrequired> (sn):	Sentinel node(s) evaluated. If 6 or more nodes (sentinel or nonsentinel) are removed, this modifier should not be used.
					</div>
					<div class="form-group col-md-6">
					  <input type="radio" name="modifier" value="(f):	Nodal metastasis confirmed by fine needle aspiration or core needle biopsy " class="">  (f):	Nodal metastasis confirmed by fine needle aspiration or core needle biopsy
					</div>
			   </div>
			   <p><i>Note: The (sn) modifier is added to the N category when a sentinel node biopsy is performed (using either dye or tracer) and fewer than six lymph nodes are removed (sentinel and nonsentinel). The (f) modifier is added to the N category to denote confirmation of metastasis by fine needle aspiration/core needle biopsy with NO further resection of nodes.</i></p>
			    <br/>
				 <h4 class="heading-title">Category (pN) <code>*</code></h4>
				<hr>
				<div class="row">
					<div class="form-group col-md-6">
					  <input type="radio" name="category" value="pNX:	Regional lymph nodes cannot be assessed (eg, not removed for pathological study or previously removed)" class="" notrequired> pNX:	Regional lymph nodes cannot be assessed (eg, not removed for pathological study or previously removed)
					</div>
					<div class="form-group col-md-6">
					  <input type="radio" name="category" value="pN0:	No regional lymph node metastasis identified or ITCs only#" class="">  pN0:	No regional lymph node metastasis identified or ITCs only#
					</div>
					<div class="form-group col-md-6">
					  <input type="radio" name="category" value="pN0 (i+):	ITCs only (malignant cell clusters no larger than 0.2 mm) in regional lymph node(s)" class="">  pN0 (i+):	ITCs only (malignant cell clusters no larger than 0.2 mm) in regional lymph node(s)
					</div>
					<div class="form-group col-md-6">
					  <input type="radio" name="category" value="pN0 (mol+):	Positive molecular findings by reverse transcriptase polymerase chain reaction (RT PCR); no ITCs detected" class="">  pN0 (mol+):	Positive molecular findings by reverse transcriptase polymerase chain reaction (RT PCR); no ITCs detected
					</div>
					<div class="form-group col-md-6">
					  <input type="radio" name="category" value="pN1mi:	Micrometastases (approximately 200 cells, larger than 0.2 mm, but none larger than 2.0 mm)" class="">  pN1mi:	Micrometastases (approximately 200 cells, larger than 0.2 mm, but none larger than 2.0 mm)
					</div>
					<div class="form-group col-md-6">
					  <input type="radio" name="category" value="pN1a:	Metastases in 1 to 3 axillary lymph nodes, at least 1 metastasis larger than 2.0 mm##" class="">  pN1a:	Metastases in 1 to 3 axillary lymph nodes, at least 1 metastasis larger than 2.0 mm##
					</div>
					<div class="form-group col-md-6">
					  <input type="radio" name="category" value="pN1b:	Metastases in ipsilateral internal mammary sentinel nodes, excluding ITCs" class="">   pN1b:	Metastases in ipsilateral internal mammary sentinel nodes, excluding ITCs
					</div>
					<div class="form-group col-md-6">
					  <input type="radio" name="category" value="pN1c:	pN1a and pN1b combined" class="">  pN1c:	pN1a and pN1b combined
					</div>
					<div class="form-group col-md-6">
					  <input type="radio" name="category" value="pN2a:	Metastases in 4 to 9 axillary lymph nodes (at least 1 tumor deposit larger than 2.0 mm)##" class="">  pN2a:	Metastases in 4 to 9 axillary lymph nodes (at least 1 tumor deposit larger than 2.0 mm)##
					</div>
					<div class="form-group col-md-6">
					  <input type="radio" name="category" value="pN2b:	Metastases in clinically detected internal mammary lymph nodes with or without microscopic confirmation; with pathologically negative axillary nodes" class="">  pN2b:	Metastases in clinically detected internal mammary lymph nodes with or without microscopic confirmation; with pathologically negative axillary nodes
					</div>
					<div class="form-group col-md-6">
					  <input type="radio" name="category" value="pN3a:	Metastases in 10 or more axillary lymph nodes (at least 1 tumor deposit larger than 2.0 mm) or metastases to the infraclavicular (Level III axillary lymph) nodes##" class="">  pN3a:	Metastases in 10 or more axillary lymph nodes (at least 1 tumor deposit larger than 2.0 mm) or metastases to the infraclavicular (Level III axillary lymph) nodes##
					</div>
					<div class="form-group col-md-6">
					  <input type="radio" name="category" value="pN3b:	pN1a or pN2a in the presence of cN2b (positive internal mammary nodes by imaging); or pN2a in the presence of pN1b" class="">  pN3b:	pN1a or pN2a in the presence of cN2b (positive internal mammary nodes by imaging); or pN2a in the presence of pN1b
					</div>
					<div class="form-group col-md-6">
					  <input type="radio" name="category" value="pN3c:	Metastases in ipsilateral supraclavicular lymph nodes" class=""> pN3c:	Metastases in ipsilateral supraclavicular lymph nodes
					</div>
			   </div>
			   <p><i># Isolated tumor cells (ITCs) are defined as small clusters of cells not greater than 0.2 mm or single tumor cells, or a cluster of fewer than 200 cells in a single histologic cross-section. ITCs may be detected by routine histology or by immunohistochemical (IHC) methods. Nodes containing only ITCs are excluded from the total positive node count for purposes of N classification but should be included in the total number of nodes evaluated. <br/><br/>## Approximately 1000 tumor cells are contained in a 3-dimensional 0.2-mm cluster. Thus, if more than 200 individual tumor cells are identified as single dispersed tumor cells or as a nearly confluent elliptical or spherical focus in a single histologic section of a lymph node, there is a high probability that more than 1000 cells are present in the lymph node. In these situations, the node should be classified as containing a micrometastasis (pN1mi). Cells in different lymph node cross-sections or longitudinal sections or levels of the block are not added together; the 200 cells must be in a single node profile even if the node has been thinly sectioned into multiple slices. It is recognized that there is substantial overlap between the upper limit of the ITC and the lower limit of the micrometastasis categories due to inherent limitations in pathologic nodal evaluation and detection of minimal tumor burden in lymph nodes. Thus, the threshold of 200 cells in a single cross-section is a guideline to help pathologists distinguish between these 2 categories. The pathologist should use judgment regarding whether it is likely that the cluster of cells represents a true micrometastasis or is simply a small group of isolated tumor cells.</i></p>
			   <br/>
				...
				<div class="row">
					...
					<div class="form-group col-md-6">
					  <input type="radio" name="distance_metastasis" value="pM1:  Histologically proven metastases larger than 0.2 mm" class=""> pM1:  Histologically proven metastases larger than 0.2 mm
	...
	<div class="row">
		<div class="col-md-12">
			<div class="heading-line-bottom">
			  <h4 class="heading-title"> Additional Pathologic Findings <a href="#" data-toggle="modal" data-target="#myModal15"> <i class="fa fa-question-circle"></i></a></h4>
			 </div>
			 ...
			 <!-- Modal -->
              <div class="modal fade" id="myModal15" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
				...
				<div class="row">
					<div class="form-group col-md-6">
						<input type="radio" name="additional_finding" value="Additional Findings " class=""> Additional Findings
						<textarea name="additional_finding_note" class="form-control" placeholder="Add Note" rows="4" cols="50"></textarea>
					</div>
				</div>

			   <div class="row">
                <div class="form-group col-md-6">
                  <input type="radio" name="ancillary_studies" value="Ancillary Studies " class="">  Ancillary Studies
                </div>
			   </div>

			   <p><i>Note: For hormone receptor and HER2 reporting for this specimen, the CAP Breast Biomarker Template should be used. Pending biomarker studies should be listed in the Comments section of this report.</i><p>

			   <div class="form-group col-md-6">
                  <input type="radio" name="breast_biomarker" value="Breast Biomarker Testing Performed on Previous Biopsy" class="">  Breast Biomarker Testing Performed on Previous Biopsy
                </div>

			   <br/>
				 <h4 class="heading-title">Estrogen Receptor (ER) </h4>
				<hr>

				  <div class="row">
					<div class="form-group col-md-6">
					  <input type="radio" name="estrogen_receptor" value="Positive" class=""> Positive
					  <p>Percent</p><input style="width: 30%" type="text" name="estrogen_receptor_percent" placeholder="% " class="form-control">
					</div>
					<div class="form-group col-md-6">
					  <input type="radio" name="estrogen_receptor" value="Negative" class=""> Negative
					</div>
					<div class="form-group col-md-6">
					  <input type="radio" name="estrogen_receptor" value="Cannot be determined (indeterminate) " class=""> Cannot be determined (indeterminate)
					</div>
				  </div>

			  <br/>
				 <h4 class="heading-title"> Progesterone Receptor (PgR)  </h4>
				<hr>

				  <div class="row">
					<div class="form-group col-md-6">
					  <input type="radio" name="progesterone_receptor" value="Positive " class=""> Positive
					  <p>Percent</p><input style="width: 30%" type="text" name="progesterone_receptor_percent" placeholder="% " class="form-control">
					</div>
					<div class="form-group col-md-6">
					  <input type="radio" name="progesterone_receptor" value="Negative" class=""> Negative
					</div>
					<div class="form-group col-md-6">
					  <input type="radio" name="progesterone_receptor" value="Cannot be determined (indeterminate) " class=""> Cannot be determined (indeterminate)
					</div>
				  </div>

			<br/>
				 <h4 class="heading-title"> HER2 (by immunohistochemistry)  </h4>
				<hr>

				  <div class="row">
					<div class="form-group col-md-6">
					  <input type="radio" name="her2" value="Negative (Score 0) " class=""> Negative (Score 0)
					</div>
					<div class="form-group col-md-6">
					  <input type="radio" name="her2" value="Negative (Score 1+)" class=""> Negative (Score 1+)
					</div>
					<div class="form-group col-md-6">
					  <input type="radio" name="her2" value="Equivocal (Score 2+) " class=""> Equivocal (Score 2+)
					</div>
					<div class="form-group col-md-6">
					  <input type="radio" name="her2" value="Positive (Score 3+)" class=""> Positive (Score 3+)
					</div>
					<div class="form-group col-md-6">
					  <input type="radio" name="her2" value="Cannot be determined (indeterminate) " class=""> Cannot be determined (indeterminate)
					</div>
				  </div>

			<br/>
				 <h4 class="heading-title"> HER2 (by in situ hybridization):</h4>
				<hr>

				  <div class="row">
					<div class="form-group col-md-6">
					  <input type="radio" name="her2_situ" value="Negative (not amplified" class=""> Negative (not amplified
					</div>
					<div class="form-group col-md-6">
					  <input type="radio" name="her2_situ" value="Positive (amplified)" class=""> Positive (amplified)
					</div>
					<div class="form-group col-md-6">
					  <input type="radio" name="her2_situ" value="Cannot be determined (indeterminate) " class=""> Cannot be determined (indeterminate)
					</div>
				  </div>
			<div class="row">
				<div class="form-group col-md-6">
				  <label>Testing Performed on Case Number:</label>
	...
	<div class="row">
		<div class="col-md-12">
			<div class="heading-line-bottom">
			  <h4 class="heading-title">Microcalcifications (select all that apply) <a href="#" data-toggle="modal" data-target="#myModal16"><i class="fa fa-question-circle"></i></a></h4>
			 </div>
              ...
              <div class="modal fade" id="myModal16" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                <div class="modal-dialog modal-lg" role="document">
                  <div class="modal-content">
                    <div class="modal-header">
                      <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                      <h4 class="modal-title" id="myModalLabel">O. Microcalcifications</h4>
                    </div>
                    <div class="modal-body">
                      <p>Cancer found in biopsies performed for microcalcifications will almost always be at the site of the calcifications or in close proximity. The presence of the targeted calcifications in the specimen should be confirmed by specimen radiography. The pathologist must be satisfied that the specimen has been sampled in such a way that the lesion responsible for the calcifications has been examined microscopically. The relationship of the radiologic calcifications to the invasive carcinoma and the DCIS should be indicated. <br/> If calcifications can be seen in the specimen radiograph but not in the initial histologic sections, deeper levels should be examined. If needed, radiographs of the paraffin block(s) may be obtained to detect calcifications remaining in the block(s). If microcalcifications cannot be confirmed by routine microscopic evaluation, polarized light may be helpful, since calcium oxalate crystals are refractile and polarizable but usually clear or tinged yellow in H&E sections. On rare occasions, calcifications do not survive tissue processing or prolonged fixation in formalin. Foreign material can sometimes simulate calcifications (eg, metallic fragments after surgery or trauma). </p>
					</div>
                    <div class="modal-footer">
                      <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                    </div>
			   ...
			   <div class="row">
                <div class="form-group col-md-6">
                  <input type="checkbox" name="microcalcifications_notidentified" value="Not identified" class=""> Not identified
                </div>
				<div class="form-group col-md-6">
                  <input type="checkbox" name="microcalcifications_present" value="Present in DCIS " class="">  Present in DCIS
                </div>
				<div class="form-group col-md-6">
                  <input type="checkbox" name="microcalcifications_presentic" value="Present in invasive carcinoma " class="">  Present in invasive carcinoma
                </div>
				<div class="form-group col-md-6">
                  <input type="checkbox" name="microcalcifications_presentnnt" value="Present in non-neoplastic tissue " class="">  Present in non-neoplastic tissue
                </div>
				<div class="form-group col-md-12">
                  <input type="checkbox" name="microcalcifications_other" value="Other" class="">  Other
				  <p>Specify <input type="text" name="microcalcifications_other_specify" placeholder="specify" class="form-control"> </p>
                </div>
			   </div>

			   <br/>
				 <h4 class="heading-title"> Clinical History (select all that apply) </h4>
				<hr>
				  <p><i>The current clinical/radiologic breast findings for which this surgery is performed include:</i></p>
				  <div class="row">
					<div class="form-group col-md-6">
					  <input type="checkbox" name="breast_finding_pm" value="Palpable mass " class=""> Palpable mass
					</div>
					<div class="form-group col-md-6">
					  <input type="checkbox" name="breast_finding_nd" value="Nipple discharge" class=""> Nipple discharge
					</div>
					<div class="form-group col-md-12">
					  <input type="checkbox" name="breast_finding_o" value="Other" class="">  Other
					  <p>Specify <input type="text" name="breast_finding_specify" placeholder="specify" class="form-control"> </p>
					</div>
					<div class="form-group col-md-12">
					  <input type="checkbox" name="breast_history" value="Prior history of breast cancer" class="">  Prior history of breast cancer
					  <p>Specify site, diagnosis, and prior treatment <input type="text" name="breast_history_finding" placeholder="specify" class="form-control"> </p>
					</div>
					<div class="form-group col-md-12">
					  <input type="checkbox" name="breast_prior_tx" value="Prior presurgical (neoadjuvant) therapy for this diagnosis of invasive carcinoma" class="">  Prior presurgical (neoadjuvant) therapy for this diagnosis of invasive carcinoma
					</div>
				  </div>


				<br/>
				 <h4 class="heading-title"> Radiologic Finding (select all that apply)  </h4>
				<hr>
				  <div class="row">
					<div class="form-group col-md-6">
					  <input type="checkbox" name="radiologic_finding_mass" value="Mass or architectural distortion " class=""> Mass or architectural distortion
					</div>
					<div class="form-group col-md-6">
					  <input type="checkbox" name="radiologic_finding_calc" value="Calcifications" class=""> Calcifications
					</div>
					<div class="form-group col-md-12">
					  <input type="checkbox" name="radiologic_finding_other" value="Other" class="">  Other
					  <p>Specify <input type="text" name="radiologic_finding_specify" placeholder="specify" class="form-control"> </p>
					</div>
				</div>
		</div>
	</div>
...
<?php /* C:\Users\DELL INSPIRON 15\Desktop\Laravel Projects\CBReporting\resources\views/breast_invasive_resection.blade.php */ ?>
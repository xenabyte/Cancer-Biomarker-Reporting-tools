    ...
    <section>
      <div id="exportContent" class="container">
        ...
        <div class="col-md-12">
            ...
            <?php endif; ?>
            <?php if($specimen_integrity != ''): ?>
                <p><strong>Specimen Integrity:</strong><span> <?php echo e($specimen_integrity); ?> </span></p>
            <?php endif; ?>
            <?php if($polypsize_gd != '' || $polypsize_cd != ''): ?>
                <p><strong>Polyp Size:</strong><?php if($polypsize_cd != ''): ?> Cannot be determined (explain): <?php echo e($polypsize_cd); ?> <?php else: ?>  Greatest dimension (centimeters): <?php echo e($polypsize_gd); ?>cm <?php if($polypsize_length != '' && $polypsize_width != ''): ?> => Additional dimensions (centimeters): <?php echo e($polypsize_length); ?>cm X <?php echo e($polypsize_width); ?>cm  <?php endif; ?>  <?php endif; ?><span></span></p>
            <?php endif; ?>
            <?php if($polyconfig != ''): ?>
                <p><strong>Polyp Configuration</strong><span><?php if($polyconfig == 'Pedunculated with stalk' ): ?> <?php echo e($polyconfig); ?> (Stalk length (centimeters): <?php echo e($polyconfig_pedun); ?>cm) <?php else: ?>  <?php echo e($polyconfig); ?>  <?php endif; ?> </span></p>
            <?php endif; ?>
            <?php if($sic_gd != '' || $sic_cd != ''): ?>
                <p><strong>Size of Invasive Carcinoma:</strong><?php if($sic_cd != ''): ?> Cannot be determined (explain): <?php echo e($sic_cd); ?> <?php else: ?>  Greatest dimension (centimeters): <?php echo e($sic_gd); ?>cm <?php if($sic_length != '' && $sic_width != ''): ?> => Additional dimensions (centimeters): <?php echo e($sic_length); ?>cm X <?php echo e($sic_width); ?>cm  <?php endif; ?>  <?php endif; ?><span></span></p>
            <?php endif; ?>
            <?php if($histologic != ''): ?>
            ...
            <?php endif; ?>
            <?php if($icm != ''): ?>
                <p><strong>Margins:<br/>Deep Margin (Stalk Margin):</strong><span><?php if($icm == 'Uninvolved by invasive carcinoma'): ?> <?php echo e($icm); ?> ( <?php if($icm_closest_margin != ''): ?> Distance of invasive carcinoma from margin(millimeters):  <?php echo e($icm_closest_margin); ?>mm ) <?php endif; ?> <?php else: ?> <?php echo e($icm); ?>  <?php endif; ?> </span></p>
            <?php endif; ?>
            <?php if($icm_mm != ''): ?>
                <p><strong>Margins:<br/>Mucosal Margin:</strong><span> <?php echo e($icm_mm); ?> </span></p>
            <?php endif; ?>
            <?php if($lymphovascular_invasion != ''): ?>
                <p><strong>Lymphovascular Invasion:</strong><?php if($lymphovascular_invasion == 'Present '): ?> <?php echo e($lymphovascular_invasion); ?> <?php if($lymphovascular_invasion_sv != ''): ?> ( <?php echo e($lymphovascular_invasion_sv); ?> )  <?php endif; ?> <?php if($lymphovascular_invasion_lv != ''): ?> ( <?php echo e($lymphovascular_invasion_lv); ?> ) <?php endif; ?> <?php else: ?> <?php echo e($lymphovascular_invasion); ?> <?php endif; ?><span></span></p>
            <?php endif; ?>
            <?php if($budding != ''): ?>
            ...
            <?php endif; ?>
            <?php if($findings_ni || $findings_uc || $findings_cd || $findings_op || $findings_ot): ?>
                <p><strong> Additional Pathologic Findings: </strong><span><?php echo e($findings_ni); ?> <?php echo e($findings_uc); ?> <?php echo e($findings_cd); ?>  <?php echo e($findings_op); ?>(<?php echo e($findings_op_specify); ?>) <?php echo e($findings_ot); ?> (<?php echo e($findings_ot_specify); ?>) </span></p>
            <?php endif; ?>
...
<?php /* C:\Users\DELL INSPIRON 15\Desktop\Laravel Projects\CBReporting\resources\views/preview_cre.blade.php */ ?>